let ref,
	...
	app = {
		...
		onDeviceReady: function() {
			...
			setTimeout(() => {
				ref = cordova.InAppBrowser.open("https://marcustansoon.github.io/PhysicsEngine.js-2D/temp/Games/BBQ-Sort/source-files/combined-index-test.html", '_blank', 'location=no,hideurlbar=yes,toolbar=no,zoom=no');
