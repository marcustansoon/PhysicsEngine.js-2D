(self.webpackChunktradingview = self.webpackChunktradingview || []).push([[57397], {
    803155: (e, t, s) => {
        e.exports = [{
            name: s.i18next(null, {
    ...
    37010: (e, t, s) => {
        ...
        var n = s(735566)
          ...
          , r = s(803912);
        const o = (0,
        n.getLogger)("ChartApi.AuthToken", {
            color: "#173"
        });
        class a {
            constructor() {
                this.invalidated = new i.Delegate,
                this._tid = 0,
                this._onOnline = () => {
                    o.logInfo("Online, new token will be fetched if needed"),
                    this.get()
                }
                ,
                window.loginStateChange || (window.loginStateChange = new i.Delegate),
                window.loginStateChange.subscribe(this, (e => {
                    e || (this._set(window.user.auth_token),
            ...
            get(e) {
                return window.is_authenticated ? !e && performance.now() < this._cache.monoValidThru && Date.now() < this._cache.wallValidThru ? (o.logInfo(`Using cached token ${this._cache.token}`),
                Promise.resolve(this._cache.token)) : window.navigator.onLine ? this._fetch(Boolean(e), 0).then((e => {
                    if (!window.is_authenticated)
                        throw new Error("User logged out while the request was in flight");
                    return this._set(e),
                    e
                }
                )).catch((e => (o.logError(`Error fetching new token: ${e && e.message}`),
                ""))) : (o.logWarn("Offline, cannot fetch new token, using cached token"),
                Promise.resolve(this._cache.token)) : Promise.resolve("")
            }
            reset() {
                this._set(void 0),
                this.invalidated.fire()
                ...
                if (window.is_authenticated && void 0 !== e) {
                    const t = function(e) {
                        ...
                        try {
                            ...
                            return o.logError(`${e} is invalid: ${t.message}`),
                            144e5
                        }
                    }(e);
                    this._cache = {
                    ...
                    this._tid = setTimeout(( () => {
                        window.navigator.onLine && this.reset()
                    }
                    ), t),
                    o.logInfo(`Cached for ${t} ms: ${e}`)
                } else
                    this._cache = {
                        token: "",
                        monoValidThru: -1 / 0,
                    ...
                    clearTimeout(this._tid),
                    o.logInfo("Cache dropped")
            }
            _fetch(e, t) {
                return o.logNormal(`Fetching a new token, grabSession=${e}`),
                (0,
                r.fetch)("/quote_token/", {
                    method: "POST",
                    headers: {
                    ...
                    if (t >= 3)
                        throw s;
                    return o.logWarn("Request failed, will retry"),
                    function(e) {
    ...
    813082: (e, t, s) => {
        ...
        var n, i = s(154834), r = s(290484), o = s(569708), a = s(650151), _ = s(735566), c = s(37010);
        !function(e) {
        ...
        class b {
            ...
            async getValue(e) {
                ...
                a.ensureNotNull)(t.headers.get("Content-Type")) ? t.json() : t.text()
            }
            async setValue(e, t) {
            ...
            async migrateValue(e, t) {
                ...
                s && (await this.setValue(t, s),
                await this._cache.delete(e))
            }
        }
        class v {
            constructor() {
            ...
            async migrateValue(e, t) {
                this._data.has(e) && (this._data.set(t, this._data.get(e)),
                this._data.delete(e))
            }
        }
        var w = s(925470)
        ...
        function N(e) {
            for (const t of Object.keys(e)) {
                ...
                "s"in e[t] && e[t].s && !s.series && (s.series = e[t].s.map(D)),
                "st"in e[t] && e[t].st && !s.series && (s.series = e[t].st.map(D))
            }
        }
        class P {
            set_broker(e) {
            ...
            create_series(e, t, s, n, i, r, o) {
                return [e, t, s = s || "", n, i, r, o]
            }
            remove_series(e, t) {
                return [e, t]
            }
            modify_series(e, t, s, n, i, r) {
                return [e, t, s = s || "", n, i, r]
            }
            ...
            create_study(e, t, s, n, i, r) {
                return [e, t, s = s || "", n, i].concat(r)
            }
            create_child_study(e, t, s, n, i, r) {
                return this.create_study(e, t, s, n, i, r)
            }
            remove_study(e, t) {
                return [e, t]
            }
            ...
            prepareDataUpdateObjects(e, t, s) {
                for (const [n,i] of Object.entries(t)) {
                    const t = "plots"in i ? i.plots : i.series
                      , r = {
                        customId: n,
                        turnaround: i.turnaround,
                        plots: t
                    };
                    "ns"in i && i.ns && (r.nonseries = i.ns),
                    "lbs"in i && i.lbs && (r.lastBar = {
                        closeTime: i.lbs.bar_close_time
                    });
                    for (const e of r.plots)
                        for (const [t,s] of Object.entries(e.value))
                            s && Math.abs(s) >= 1e100 && (e.value[+t] = void 0);
                    s(e, n, {
                        method: T.WebchartChartSessionResponseMethod.DataUpdate,
                        params: r
                    })
                }
            }
        ...
        const E = (0,
        _.getLogger)("Chart.Studies.StudyMetaInfoRepository", {
            color: "#606"
        })
          , F = (0,
        _.getLogger)("ChartApi.TrafficMeter", {
            maxCount: 20,
            color: "#268"
        })
          , L = (0,
        _.getLogger)("ChartApi.Core", {
            color: "#706"
        })
          , A = (0,
        _.getLogger)("ChartApi.ChartSession", {
            color: "#706"
        })
          , O = (0,
        _.getLogger)("ChartApi.ChartSession", {
        ...
        _.getLogger)("ChartApi.ChartSession", {
          ...
          , U = (0,
        _.getLogger)("ChartApi.QuoteSession", {
            maxCount: 50,
            color: "#660"
        })
          , $ = (0,
        _.getLogger)("ChartApi.QuoteSession", {
          ...
          , V = !(0,
        q.isOnMobileAppPage)("any")
          , W = (0,
        k.isFeatureEnabled)("broker_id_session");
        let Q = !1
          , j = !1
          , z = !1;
        const J = ["", "KB", "MB", "GB", "TB"];
        function Z(e) {
            if (0 === e)
                return "0";
            const t = (0,
            C.toInt)(Math.floor(Math.log(e) / Math.log(1024)));
            return (e / Math.pow(1024, t)).toFixed(2) + J[t]
        }
        function G(e, t) {
            return `${e}__${t}`
        }
        ...
        const K = Y.bind(null, 1)
          , X = Y.bind(null, -1)
          , ee = d.enabled("widget") ? "studies_metadata_widget" : "studies_metadata"
          , te = "/chart-api/pro_hash"
          , se = d.enabled("widget") ? "/chart-api/studies_metadata_widget" : "/chart-api/studies_metadata";
        function ne(e) {
            if (null === e)
                return "";
        ...
        class oe {
            constructor(e) {
                this.sessionid = null,
                this._banInfo = new x.WatchedValue(null),
                ...
                this._connectionsLimitReached = new x.WatchedValue(!1),
                ...
                this._wsBackendConnection.setLogger(L, _.getLogHistory),
                this._wsBackendConnection.setTelemetry(M.telemetry),
                this._bindSocketEvents(),
                this._isNonCountedStudy = () => !0,
                setInterval(( () => {
                    F.logNormal("Last 30 seconds:" + Z(this._trafficStats.lastChunk) + " Since last connect:" + Z(this._trafficStats.sinceConnect) + " Total traffic:" + Z(this._trafficStats.total)),
            ...
            defaultResolutions() {
                return (0,
                l.getDefaultResolutions)()
            }
            availableCurrencies() {
                return re().then((e => e.currencies))
            }
            availableUnits() {
                return re().then((e => {
                    const t = {};
            ...
            supportedSymbolsTypes() {
                ...
                return "bovespa" === e ? m.filter((e => ["", "stock", "futures", "index"].includes(e.value))) : "cme" === e ? m.filter((e => e.value !== u)) : m
            }
            symbolsGrouping() {
                return {
                    futures: /^(.+?)([12]!|\w\d{4})?$/
            ...
            authTokenManager() {
                return (0,
                a.ensureDefined)(this._authTokenManager)
            }
            createSession(e, t) {
                this._sessions[e] = t,
            ...
            resolveSymbol(e, t, s, n) {
                return M.telemetry.timeCounters.series["resolve_symbol_" + e] = window.performance.now(),
                this._notificationHandlers[e][t] = new I(n,t,!0),
                this._sendRequest("resolve_symbol", [e, t, s])
            }
            requestFirstBarTime(e, t, s, n) {
                return this._notificationHandlers[e][t] = new I(n,t,!0),
                this._sendRequest("get_first_bar_time", [e, t, s])
            }
            createSeries(e, t, s, n, i, r, o, a) {
                M.telemetry.timeCounters.series.marks.push("create_series_" + e),
                this._notificationHandlers[e][t] = new I(a,t);
                const _ = ne(o);
                return this._sendRequest("create_series", [e, t, s, n, i, r, _])
            }
            removeSeries(e, t) {
                return delete this._notificationHandlers[e][t],
                this._sendRequest("remove_series", [e, t])
            }
            modifySeries(e, t, s, n, i, r, o, a) {
                this._notificationHandlers[e][t] = new I(a,t);
                const _ = ne(o);
            ...
            requestMoreData(e, t, s, n) {
                ...
                const i = t;
                return this._notificationHandlers[e][i] = new I(n,i),
                this._sendRequest("request_more_data", [e, i, s])
            }
            requestMoreTickmarks(e, t, s, n) {
                return n && (this._notificationHandlers[e][t] = new I(n,t)),
            ...
            canCreateStudy(e, t, s) {
                const {id: n, child: i, fundamental: r} = t
                  , o = (0,
                a.ensureNotNull)((0,
                w.getConfig)("STUDY_ON_STUDY")).child_limit;
                if (i && (!(0,
                w.enabled)("STUDY_ON_STUDY") || (this._childStudyCounter[e] ?? 0) >= o))
                    return {
                        success: !1,
                        reason: "child",
                        limitValue: o
                ...
                const _ = (0,
                a.ensureNotNull)((0,
                w.getConfig)("FUNDAMENTALS_ON_CHART")).limit;
                if (r && (!(0,
                w.enabled)("FUNDAMENTALS_ON_CHART") || this.getFundamentalCounter(e) >= _))
                    return {
                        success: !1,
                        reason: "fundamental",
                        limitValue: _
                ...
                const c = (0,
                a.ensureNotNull)((0,
                w.getConfig)("INDICATORS_ON_CHART")).limit;
                return r || this._isNonCountedStudy(n) || (0,
                w.enabled)("INDICATORS_ON_CHART") && !(this.getStudyCounter(e) >= c) ? {
                    success: !0
                } : {
                    success: !1,
                    reason: "general",
            ...
            createStudy(e, t, s, n, i, r, o, a) {
                const _ = this.canCreateStudy(e, a);
                return _.success || "child" !== _.reason ? (this._notificationHandlers[e][t] = new I(o,t),
                this._sendRequest("create_study", [e, t, s, n, i, r]),
                ...
                this._studySpecs.set(G(e, t), a),
                !0) : ((0,
                f.showTooManyStudiesNotice)(_.limitValue),
                !1)
            }
            modifyStudy(e, t, s, n, i, o) {
                Y(o = o ?? 0, this._childStudyCounter, e),
                0 !== o && ((0,
                a.ensureDefined)(this._studySpecs.get(G(e, t))).child = o > 0),
                this._notificationHandlers[e][t] = new I(i,t);
                const _ = e + t;
                if (this._modifyStudyMap.has(_)) {
                    return (0,
                    a.ensureDefined)(this._modifyStudyMap.get(_))(e, t, s, n) ?? !0
                }
                {
                    const i = (0,
                    r.default)(( (e, t, s, n) => this._sendRequest("modify_study", [e, t, s, n])), 500, {
                        maxWait: 550
                    });
                    return this._modifyStudyMap.set(_, i),
                    i(e, t, s, n) ?? !0
                }
            }
            notifyStudy(e, t, s, n) {
                return L.logNormal(`Send notify_study, [${e}, ${t}, ${s}, ${JSON.stringify(n)}]`),
            ...
            removeStudy(e, t) {
                ...
                const i = G(e, t)
                  , r = (0,
                a.ensureDefined)(this._studySpecs.get(i));
                return this._studySpecs.delete(i),
                r.fundamental ? X(this._fundamentalCounter, e) : this._isNonCountedStudy(r.id) || X(this._studyCounter, e),
                r.child && X(this._childStudyCounter, e),
                n
            }
            createPointset(e, t, s, n, i, r, o) {
                return this._notificationHandlers[e][t] = new I(o,t),
                this._sendRequest("create_pointset", [e, t, s, n, i, r])
            }
            modifyPointset(e, t, s, n, i) {
                return this._notificationHandlers[e][t] = new I(i,t),
            ...
            _sendRequest(e, t) {
                ...
                0 !== this._sendingQueuedRequestsCount)
                    ...
                    !0;
                const n = this._dataHandleModule[e].apply(this._dataHandleModule, t)
                  , i = {
                    m: e,
                    p: n
                }
                ...
                if (n.length > 0) {
                    const e = n[0];
                    e.startsWith("qs_") ? U.logNormal("send: " + r) : e.startsWith("cs_") && A.logNormal("send: " + r)
                } else
                    L.logNormal("send: " + r);
                const o = this._dataHandleModule.prepareEncodeMessage(e, n);
                return this._wsBackendConnection.send(o)
            }
            _onConnect() {
                if (this.connected())
                    return;
                ...
                if (L.logInfo("Time shift with server: " + this._formatTime(this.serverTime() - Date.now())),
                this._authTokenDfd) {
                    this._sendingQueuedRequestsCount += 1,
                    L.logInfo("Wait for auth token before send messages");
                    const e = this._authTokenDfd;
                    e.then((t => {
                        if (null !== this._authTokenDfd && this._authTokenDfd === e) {
                            if (L.logNormal("Auth token request is finished, token: " + Boolean(t)),
                            this._authTokenDfd = null,
                            t) {
                                const e = [{
                            ...
                            L.logNormal("Comes auth token after requesting new token or after socket disconnected")
                    }
                    )).catch((e => {
                        L.logNormal((0,
                        y.errorToString)(e))
                    ...
                    L.logWarn("Deferred auth token object is not valid"),
                    this._isAuthTokenLoaded = !0;
                "" !== this._brokerId && this._sendBrokerIdToSession(this._brokerId);
                const s = this._wsBackendConnection.getConnectionStart();
                window.TradingView.WEB_SOCKET_WAS_CONNECTED = !0,
                M.telemetry.setSessionInfo(this.sessionid),
                M.telemetry.sendChartReport("websocket_connected"),
                M.telemetry.sendChartReport("websocket_connection_time_frame", {
                    value: t - s
                }),
                M.telemetry.sendChartReport("reconnect_count_frame", {
                    value: this._wsBackendConnection.getReconnectCount()
                }),
                M.telemetry.sendChartReport("redirect_count_frame", {
                    value: this._wsBackendConnection.getRedirectCount()
                }),
                Q || (Q = !0,
                M.telemetry.sendChartReport("before_websocket_connection_time_frame", {
                    value: s
                })),
            ...
            _dispatchNotification(e, t) {
                ...
                if (e.method === T.WebchartChartSessionResponseMethod.StudiesMetadata && null !== this._metadataDeferredPromise)
                ...
                if ("symbol_resolved" === e.method) {
                    ...
                    M.telemetry.sendChartReport("symbol_resolved", {
                        count: 1,
                        additional: {
                            symbol: t
                        }
                    });
                    const n = M.telemetry.timeCounters.series["resolve_symbol_" + s];
                    "number" == typeof n && M.telemetry.sendChartReport("symbol_resolve_time_frame", {
                ...
                if (["series_error", "series_completed"].includes(e.method) && M.telemetry.timeCounters.series.marks.length > 0) {
                    const e = "create_series_" + s
                      , t = M.telemetry.timeCounters.series.marks.indexOf(e);
                    t >= 0 && M.telemetry.timeCounters.series.marks.splice(t, 1)
                }
                z || "series_error" !== e.method || (z = !0);
                const n = this._wsBackendConnection.getConnectionEstablished();
                if (null !== n && "series_completed" === e.method && (z || (z = !0,
                M.telemetry.sendChartReport("first_series_full_time_frame", {
                    value: window.performance.now() - n
                }),
                M.telemetry.timeCounters.series.marks = []),
                j || (j = !0,
                M.telemetry.sendChartReport("page_full_load_time_frame", {
                    value: window.performance.now()
                }))),
                s.startsWith("cs_")) {
                    let s = "recv: " + t;
                    "data_update" === e.method ? (s = (0,
                    _.isHighRateEnabled)() ? s : s.slice(0, 500),
                    O.logNormal(this._appendDuration(s, e.time))) : "study_loading" === e.method ? B.logNormal(this._appendDuration(s, e.time)) : "tickmark_update" === e.method ? H.logNormal(this._appendDuration(s, e.time)) : A.logNormal(this._appendDuration(s, e.time))
                }
                if (s.startsWith("qs_")) {
                    ("quote_symbol_data" === e.method ? $.logNormal : U.logNormal)("recv: " + t)
                }
                switch (e.method) {
                ...
                case T.WebchartResponseMethod.CriticalError:
                    L.logInfo(new Date + " critical_error session:" + this.sessionid + " reason:" + e.params[0]),
                    M.telemetry.sendChartReport("critical_error"),
                    this._sessions[s].onMessage({
            ...
            _onMessage(e) {
                ...
                "t_ms"in t && (0,
                o.default)(t.t_ms) && window.ChartApiInstance.compensateConnectionLag(t.t_ms),
                "protocol_switched" !== t.method ? "protocol_error" !== t.method ? this._dispatchNotification(t, e) : this._processProtocolError(t) : L.logError("Unexpected protocol changing request, try skipping. Requested protocol:" + t.params[0])
            }
            async _processedMetadata(e) {
                const t = (0,
                a.ensureNotNull)(this._metadataDeferredPromise)
                ...
                try {
                    ...
                    i.default)(e));
                    const o = Array.from(new Set(e.params[1].metainfo.map((e => {
                        return `${(t = (0,
                        R.parseIdString)(e.id)).packageId}-${t.version}`;
                        var t
                    }
                    ))));
                    if (L.logNormal(`Updated studies_metadata cache, unique package ids: ${o.join(", ")}`),
                    !r)
                        try {
                            await s.setValue(te, (0,
                            i.default)(n)),
                            L.logNormal("Updated pro_hash cache")
                        } catch (e) {
                            t.reject(),
                            L.logError("Cannot update pro_hash cache, reason: " + e)
                        }
                } catch (e) {
                    t.reject(),
                    L.logError("Cannot update studies_metadata cache, reason: " + e)
                }
                t.resolve((0,
                i.default)(e))
            }
            ...
            async _requestMetadata() {
                ...
                E.logNormal(`Requesting metainfo #${e}`);
                const t = (0,
                a.ensureNotNull)(this._metadataDeferredPromise)
                  , s = window.pro
                  , n = s.hash()
                  , r = d.enabled("widget");
                L.logNormal("Requesting pro hash");
                try {
                    const o = await this._initCachePromise;
                    await o.migrateValue("pro_hash", te),
                    await o.migrateValue(ee, se);
                    const a = await o.getValue(te);
                    if (null !== a && a === n || r) {
                        L.logNormal("Pro hash has not changed, requesting from local");
                        const r = await o.getValue(se)
                          , a = null !== r && r.params[1].hash || null;
                        if (null === a || null === this._metadataServerHash || this._metadataServerHash !== a)
                            L.logNormal(`Metadata hash has changed (cached: '${a}', server: '${this._metadataServerHash}')`),
                            this._requestMetadataFromServer(e);
                        else {
                            if (!s.hasPackage("tv-volumebyprice") || void 0 !== r.params[1].metainfo.find((e => e.id.includes("@tv-volumebyprice"))))
                                return L.logNormal("Using studies_metadata from browser cache"),
                                void t.resolve((0,
                                i.default)(r));
                            L.logNormal(`De-sync detected! pro.hash contains VbPR studies, but data from cache doesn't and pro.hash isn't changed, pro.hash=${n}`),
                            this._requestMetadataFromServer(e)
                        }
                    } else
                        L.logNormal(`Pro hash has changed (cached: '${a}', current: '${n}')`),
                        this._requestMetadataFromServer(e)
                } catch (t) {
                    L.logError("Cannot get studies_metadata, reason: " + t),
                    this._requestMetadataFromServer(e)
                } finally {
                    E.logNormal(`Requesting studies metadata #${e} finished`)
                }
            }
            _makeNextRequestId() {
            ...
            _processProtocolError(e) {
                const t = e.params[0];
                L.logError(`Protocol error. Reason=${t}.`),
            ...
            _requestMetadataFromServer(e) {
                return L.logNormal("Request studies_metadata from server"),
                ...
                this.connectDfd = new Promise(( (e, t) => {
                    ...
                    this._wsBackendConnection.on("disconnect", ( () => {
                        ...
                        this._wsBackendConnection.isConnected() && (this._telemetryDisconnectTimeout = setTimeout(( () => {
                            M.telemetry.sendChartReport("disconnect")
                        }
                        ), 5e3),
                        this._wsBackendConnection.isMaxReconnects() && (this._notifySessions({
                            method: n.ReconnectBailout,
                            params: []
                        }),
                        t(),
                        M.telemetry.sendChartReport("reconnect_bailout")))
                    }
                    ))
                }
                ))
            ...
            _sendBrokerIdToSession(e) {
                return !W || this._sendRequest("set_broker", [e])
            }
            ...
            _getAuthTokenDfd(e) {
                ...
                if (d.enabled("widget") || -1 !== window.location.search.indexOf("widget_token") || -1 !== window.location.hash.indexOf("widget_token")) {
                    const e = window.TradingView && window.TradingView.widgetCustomer || "";
                    return Promise.resolve(h[e] || "widget_user_token")
                }
                return window.is_authenticated ? (this._authTokenManager || (this._authTokenManager = new c.AuthToken,
            ...
            _onSendingQueueRequestFinished() {
                this._sendingQueuedRequestsCount -= 1,
                L.logInfo(`Sending queue request finished. Remaining pending requests=${this._sendingQueuedRequestsCount}`),
                this._sendingQueuedRequestsCount < 0 && L.logError(`Invalid queue state=${this._sendingQueuedRequestsCount}`),
                0 === this._sendingQueuedRequestsCount && this._flushPendingMessages()
            }
            _flushPendingMessages() {
                L.logInfo(`Flush pending messages. Count=${this._pendingMessagesQueue.length}`),
                this._pendingMessagesQueue.forEach((e => this._sendRequest(e.method, e.args))),
                this._pendingMessagesQueue = []
            }
        }
        window.ChartApiInstance = new oe(window.WSBackendConnection)
    }
    ,
    207815: (e, t, s) => {
        "use strict";
    ...
    235267: (e, t, s) => {
        ...
        window.TradingView.QuoteSession = i
    }
    ,
    778003: (e, t, s) => {
        "use strict";
    ...
    241361: (e, t, s) => {
        ...
        var n, i, r;
        s.d(t, {
            WebchartChartSessionResponseMethod: () => i,
            WebchartReplaySessionResponseMethod: () => r,
            WebchartResponseMethod: () => n
        }),
        function(e) {
    ...
    855247: (e, t, s) => {
        "use strict";
        s.d(t, {
            numOfDecimalPlaces: () => i
        });
        var n = s(960521);
        function i(e) {
            return (new n.Big(e).toFixed().split(".")[1] || "").length
        }
    }
    ,
    544151: (e, t, s) => {
        ...
        s.d(t, {
            getMinTick: () => c,
            getMinTickData: () => _,
            makePriceIndexToPriceConverter: () => h,
            makePriceToPriceIndexConverter: () => u,
        ...
        function _(e) {
            const {minTick: t, price: s, variableMinTickData: n, shouldCheckForEquality: r} = e
              , o = (0,
            i.isNumber)(t) ? d(t) : t;
            return void 0 === n ? o : function(e, t, s=!1) {
        ...
        function l(e, t) {
            ...
            try {
                ...
                for (let t = 0; t < e.length; t += 2) {
                    const i = e[t + 1] ?? 1 / 0
                      , r = s[s.length - 1]?.price ?? 0
                      , o = s[s.length - 1]?.maxIndex ?? 0
                      , _ = i === 1 / 0 ? 1 / 0 : new n.Big(i).minus(r).div(a(e[t])).plus(o).toNumber();
                    s.push({
                        minTick: e[t],
                        price: i,
                        maxIndex: _
        ...
        function u(e, t) {
            return s => {
                if (!Number.isFinite(s))
                    return NaN;
                if (void 0 === t)
                    return new n.Big(s).div(e).round().toNumber();
                for (let e = 0; e < t.length; e++) {
                    const {price: i, minTick: r} = t[e]
                      , o = t[e - 1]?.price ?? 0
                      , _ = t[e - 1]?.maxIndex ?? 0;
                    if (s < i)
                        return new n.Big(s).minus(o).div(a(r)).plus(_).round().toNumber()
                }
                return NaN
            }
        }
        function h(e, t) {
            return s => {
                ...
                if (void 0 === t)
                    return (0,
                    n.Big)(s).mul(e).toNumber();
                for (let e = 0; e < t.length; e++) {
                    const {maxIndex: i, minTick: r} = t[e]
                      , o = t[e - 1]?.price ?? 0
                      , _ = t[e - 1]?.maxIndex ?? 0;
                    if (s < i)
                        return new n.Big(s).minus(_).mul(a(r)).plus(o).toNumber()
                }
                return NaN
            }
        }
    ...
    976531: (e, t, s) => {
        ...
        const r = {
          ...
          , c = new Map([["en", r], ["th", r], ["ja", r], ["ko", r], ["zh", r], ["zh_TW", r], ["ar", r], ["he_IL", r], ["ms_MY", r], ["vi", r], ["de", o], ["es", o], ["it", o], ["tr", o], ["pt", o], ["id_ID", o], ["fr", a], ["pl", a], ["ru", a]]);
        function d(e) {
            if (e)
                return {
                    decimalSign: i.decimalSign,
                    groupingSeparator: ""
                };
            const t = n || window.language || "";
            return c.get(t) ?? _
        }
    }
    ,
    220129: (e, t, s) => {
        ...
        s.d(t, {
            PriceFormatter: () => k,
            isFormatterHasForexAdditionalPrecision: () => w
        });
        var n = s(960521)
          , i = s(735566)
          , r = s(650151)
        ...
        function l(e, t, s) {
            ...
            a.getMinTickData)({
              ...
              , {priceScale: i, minMove: o, minMove2: _} = n;
            return {
                priceScale: i,
                minMove: o,
                fractionalLength: d(i, o, e, _)
            }
        }
        class u {
            constructor(e) {
                this._formatterErrors = {
                    custom: o.t(null, void 0, s(366123)),
                    fraction: o.t(null, void 0, s(339643)),
                    secondFraction: o.t(null, void 0, s(370784))
                };
                const {priceScale: t, minMove: n, minMove2: i, ignoreMinMove: r, variableMinTick: _, fractionalLength: c} = e;
                this._priceScale = t,
                this._minMove = n,
                this._minMove2 = i,
                this._ignoreMinMove = r,
                this._variableMinTickData = void 0 === _ ? void 0 : (0,
                a.makeVariableMinTickData)({
                    priceScale: t,
                    minMove: n,
                    minMove2: i
                }, _),
            ...
            formatImpl(e, t={}) {
                const {signPositive: s, signNegative: n=!0, tailSize: i, cutFractionalByPrecision: r=!1, useRtlFormat: o=!0, variableMinTickDataPrice: a, ignoreLocaleNumberFormat: c, removeAllEndingZeros: d} = t;
                let l = "";
                e < 0 ? l = !1 === n ? "" : "−" : e && !0 === s && (l = "+");
                const u = l + this._formatUnsigned(Math.abs(e), i, r, a, c, d);
                return o ? (0,
                _.forceLTRStr)(u) : u
            }
            parse(e, t) {
                return "+" === (e = (e = (0,
                _.stripLTRMarks)(e)).replace("−", "-"))[0] && (e = e.substring(1)),
                this._parseUnsigned(e, t)
            }
            _removeEndingZeros(e, t) {
                for (let s = 0; s < t && "0" === e[e.length - 1]; s++)
        ...
        var h = s(781441)
          ...
          , p = s(976531);
        const f = (0,
        i.getLogger)("Chart.DecimalPriceFormatter");
        class g extends u {
            constructor(e) {
                super(e);
                const {minMove2: t, ignoreLocaleNumberFormat: s} = e;
                void 0 !== t && 10 !== t && 0 !== t && 1 !== t && f.logDebug("invalid minmove2"),
                this._ignoreLocaleNumberFormat = s
            }
            ...
            _formatUnsigned(e, t, s, n, i, r) {
                const o = {
                    ...
                    tailSize: t,
                    cutFractionalByPrecision: s,
                    ignoreLocaleNumberFormat: i,
                    removeAllEndingZeros: r
                };
                return void 0 !== this._variableMinTickData && (Object.assign(o, l(!1, this._variableMinTickData, n ?? o.price)),
                this._ignoreMinMove && (o.minMove = 1)),
                this._formatAsDecimal(o)
            }
            _formatAsExponential(e, t) {
                const s = Math.floor(.75 * Math.log10(this._priceScale))
                  , n = e * Math.pow(10, s)
                  , i = `e-${s}`
                  , r = Math.log10(this._priceScale) - s;
                return `${n.toFixed(r).replace(".", t.decimalSign)}${i}`
            }
            _formatAsDecimal(e) {
                const {price: t, priceScale: s, minMove: i, fractionalLength: r=0, tailSize: o=0, cutFractionalByPrecision: a, ignoreLocaleNumberFormat: _, removeAllEndingZeros: c} = e
                  , d = (0,
                p.getNumberFormat)(this._ignoreLocaleNumberFormat || _);
                if (t >= 1e21)
                    return t.toString().replace(".", d.decimalSign);
                if (s > 1e15)
                    return this._formatAsExponential(t, d);
                const l = Math.pow(10, o) * s / (a ? 1 : i)
                  , u = 1 / l;
                let f;
                if (l > 1)
                    f = Math.floor(t);
                    ...
                    f = 0 === Math.round((t - e) / u) ? e : e + u
                }
                let g = "";
                if (l > 1) {
                    let e = a ? new n.Big(t).mul(l).round(void 0, 0).minus(new n.Big(f).mul(l)).toNumber() : parseFloat((Math.round(t * l) - f * l).toFixed(r));
                    e >= l && (e -= l,
                    f += 1),
                    e = a ? new n.Big(e).round(r, 0).toNumber() : parseFloat(e.toFixed(r)) * i;
                    const s = (0,
                    m.numberToStringWithLeadingZero)(e, r + o)
                      , _ = this._removeEndingZeros(s, c ? s.length : o);
                    g = _ ? d.decimalSign + _ : _
                }
                return (0,
                h.formatNumber)(f, d) + g
            }
            _parseAsDecimal(e, t={}) {
                const {ignoreLocaleNumberFormat: s} = t
                  , n = (0,
                p.getNumberFormat)(this._ignoreLocaleNumberFormat || s)
                  , i = (0,
                h.parseNumber)(e, n);
                return Number.isFinite(i) ? {
                    value: i,
                    res: !0,
                    suggest: this.formatImpl(i)
                } : {
        ...
        const y = (0,
        i.getLogger)("Chart.FractionalPriceFormatter");
        class b extends u {
            constructor(e) {
                super(e);
                const {minMove2: t} = e;
                null != t && t > 0 && 2 !== t && 4 !== t && 8 !== t && y.logDebug("invalid minmove2")
            }
            hasForexAdditionalPrecision() {
                return !1
            }
            ...
            _formatUnsigned(e, t, s, n) {
                ...
                return void 0 !== this._variableMinTickData && Object.assign(i, l(!0, this._variableMinTickData, n ?? i.price)),
                this._formatAsFractional(i)
            }
            _parseAsSingleFractional(e) {
                ...
                if (t = new RegExp("^(-?)([0-9]+)\\" + p.formatterOptions.decimalSignFractional + "([0-9]+)$").exec(e),
                t) {
                    const e = !!t[1]
                      , s = parseInt(t[2])
                      , n = this._priceScale
                      , i = this._patchFractPart(parseInt(t[3]), 1, n);
                    if (i >= n || i < 0)
                        return {
            ...
            _parseAsDoubleFractional(e) {
                ...
                if (t = new RegExp("^(-?)([0-9]+)\\" + p.formatterOptions.decimalSignFractional + "([0-9]+)\\" + p.formatterOptions.decimalSignFractional + "([0-9]+)$").exec(e),
                t) {
                    const e = !!t[1]
                      , s = parseInt(t[2])
                      , n = void 0 !== this._minMove2 && null !== this._minMove2 ? this._minMove2 : NaN
                      , i = this._priceScale / n
                      , r = this._minMove2
                      , o = this._patchFractPart(parseInt(t[3]), 1, i)
                      , a = this._patchFractPart(parseInt(t[4]), 2, r);
                    if (o >= i || o < 0)
                        return {
                            error: this._formatterErrors.fraction,
                            res: !1
            ...
            _patchFractPart(e, t, s) {
                ...
                return 2 === s ? void 0 === n[e] ? -1 : n[e] : 4 === s ? void 0 === i[e] ? -1 : i[e] : 8 === s && 2 === t ? void 0 === r[e] ? -1 : r[e] : e
            }
            _formatAsFractional(e) {
                const {price: t, tailSize: s, priceScale: n, minMove: i, minMove2: r, fractionalLength: o} = e
                  , a = n / i;
                let _ = Math.floor(t)
                  , c = s ? Math.floor(t * a) - _ * a : Math.round(t * a) - _ * a;
                c === a && (c = 0,
                _ += 1);
                let d = "";
                if (s) {
                    let e = (t - _ - c / a) * a;
                    e = Math.round(e * Math.pow(10, s)),
                    d = (0,
                    m.numberToStringWithLeadingZero)(e, s),
                    d = this._removeEndingZeros(d, s)
                }
                if (!o)
                ...
                if (r) {
                    ...
                    c = (c - e) / r;
                    const t = (0,
                    m.numberToStringWithLeadingZero)(c, o)
                      , s = this._getFractPart(e, 2, r);
                    l = t + p.formatterOptions.decimalSignFractional + s
                } else
                    c = this._getFractPart(c, 1, n),
                    l = (0,
                    m.numberToStringWithLeadingZero)(c * i, o);
                return _.toString() + p.formatterOptions.decimalSignFractional + l + d
            }
            _getFractPart(e, t, s) {
                const n = [0, 5]
                  , i = [0, 2, 5, 7]
        ...
        class k {
            constructor(e={}) {
                this.type = "price";
                const {minMove2: t, fractional: s, variableMinTick: n, ignoreMinMove: i, ignoreLocaleNumberFormat: r} = e
                  , o = !e.minMove || i ? 1 : e.minMove
                  , a = (0,
                v.isNumber)(e.priceScale) && (0,
                v.isInteger)(e.priceScale) ? e.priceScale : 100
                  , _ = d(a, o, s, t)
                  , c = {
                    ...e,
                    minMove: o,
                ...
                this._minMove2 = t,
                this._fractional = s,
                this._variableMinTick = n,
                this._ignoreMinMove = i,
                this._fractionalLength = _,
                this._ignoreLocaleNumberFormat = r,
                this._implementation = s ? new b(c) : new g(c)
            }
            isFractional() {
    ...
    894645: (e, t, s) => {
        "use strict";
        s.d(t, {
            getDefaultResolutions: () => r
        });
        var n = s(213377)
          , i = s(303999);
        function r() {
            const e = ["1", "3", "5", "15", "30", "45", "60", "120", "180", "240", "1D", "2D", "1W", "1M", "3M", "6M", "12M", "1R", "10R", "100R", "1000R"];
            if (!n.enabled("widget")) {
                let t = ["1S", "5S", "10S", "15S", "30S", "45s"];
                return (0,
                i.isTicksEnabled)() && (t = ["1T", "10T", "100T", "1000T"].concat(t)),
                t.concat(e)
            }
            return e
        }
