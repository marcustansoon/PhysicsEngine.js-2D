  ...
  this.addEventListener("load", function() {
    try {
      ...
      if (text && text.includes("#EXTM3U")) {
        console.log("🎬 HLS detected: "+ this._url);
        ...
        if (text.includes("#EXT-X-STREAM-INF")) {
          console.log("👉 MASTER PLAYLIST");
			...
			console.log("🎬 Segments:", absoluteSegments);

			const first10 = absoluteSegments.slice(0, 10);

			first10.forEach(async (url, i) => {
			  try {
			    const r = await fetch(url);
			    const blob = await r.blob();
			
			    console.log(`✅ Segment ${i + 1}:`, url, blob);alert(`✅ Segment ${i + 1}:`);
			    ...
			    a.href = blobUrl;
			    a.download = `segment_${i + 1}.ts`; // or .m4s depending on format
			    ...
			    console.error(`❌ Failed segment ${i + 1}:`, url);alert(`❌ Failed segment ${i + 1}:`);
			  }
			});
