webpackJsonp([3], [, , , function(e, t, n) {
    (function(t) {
        ...
        if (r.regeneratorRuntime = void 0, e.exports = n(593), o) r.regeneratorRuntime = i;
        else try {
    ...
    var r = t.groupOrderKey = "groupOrderId",
        ...
        v = (t.setCart = function() {
            return localStorage.setItem(a, g())
        ...
        g = (t.removeGroupOrderOtp = function() {
    ...
    }, t.extractPathnameFromUrl = function(e) {
        try {
    ...
    var o = function() {
        ...
        v = (t.getDpsSessionHeader = function(e, t) {
    ...
    (function(e, r) {
        ...
        u.createFromMenuItem = function(e, t) {
            ...
            var a = new u({
                ...
                packaging_price: o.packaging_price || 0,
                code: String(e.code),
                ...
                products: r.cloneDeep(e.products)
            });
    ...
    var i = n(618),
        ...
        v = r(h),
        g = v.default;
    g.Body = a.default, g.Header = f.default, g.Description = l.default, g.CloseButton = u.default, g.Mask = p.default, t.default = g
}, , , , function(e, t, n) {
    "use strict";
    ...
    (function(e) {
        ...
        t.default = {
            ...
            getRouteData: function(e, t) {
                ...
                return (VOLO.verticalTab || t) && (n.verticalTab = VOLO.verticalTab || "shop"), "pickup" !== e.expedition_type && "dine_in" !== e.expedition_type || (n.expedition_type = e.expedition_type), n
            },
        ...
        var a = function() {
            ...
            g = t.VendorService = function() {
                function e(t) {
                    ...
                    }), this.appConfig = r, this.discoVariant = (0, s.get)(r, "features.flags.organic-list", h), this.discoSearchConfig = (0, s.get)(r, "features.flags.search-config", v), "string" != typeof this.discoSearchConfig && (this.discoSearchConfig = v)
                }
                return a(e, [{
    ...
    (function(e) {
        ...
        var _ = [],
            y = ["Restaurant List Page", "Restaurant Detail Page", "Checkout", "Success Page", "City Page"];
        VOLO.previousUrl = VOLO.previousUrl || document.referrer;
        var b = g.default.get("app-type"),
            w = g.default.get("dhhPerseusGuestId"),
            O = g.default.get("dhhPerseusHitId"),
            k = g.default.get("dhhPerseusSessionId"),
            C = VOLO.configuration && VOLO.configuration.features && VOLO.configuration.features.flags && VOLO.configuration.features.flags.abTestBlockedFlags ? VOLO.configuration.features.flags.abTestBlockedFlags : [],
            S = t.MKT_PAGE_VIEW_EVENT = {
                event: "mktPageView"
            },
            P = t.GTM_PUSH_EVENT = "GTM:PUSH",
            T = t.GTM_PAGE_CHANGE_EVENT = "GTM:PAGE_CHANGED",
            E = function() {
                function t() {
                    var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
                    o(this, t), this.localGtm = null, this.appConfig = e.appConfig, this.locationModel = e.locationModel, this.customerModel = e.customerModel, this.localStorage = e.localStorage || window.localStorage, this.sessionStorage = e.sessionStorage || window.sessionStorage, this.fakeLocalStorage = e.fakeLocalStorage || window.fakeLocalStorage, this.dataLayer = e.dataLayer || window.dataLayer, this.tagManager = e.tagManager || VOLO.tagManager, this.userAddressCollection = e.userAddressCollection, this.events = e.eventsLord, this.productCount = e.productCount, this.events.on(P, this.push.bind(this)), this.events.on(T, this.pageChanged.bind(this)), location.search && !this.localStorage.localUtm && this._setItem(this.localStorage, "localUtm", location.search), this.sessionStorage.referrerInitial || this._setItem(this.sessionStorage, "referrerInitial", this.tagManager.referrer), this.avoInspector = new m.AvoInspector({
                        apiKey: VOLO.configuration.avoApiKey,
                        env: window.location.hostname.includes("www.") ? "prod" : "staging",
                        version: VOLO.configuration.appVersion,
                        appName: "b2c"
                    })
                }
                return s(t, [{
                    ...
                    key: "_sendOnlyOnce",
                    value: function(t) {
                        return this.localGtm && this._getEventCount(t) > 0 && e.contains(_, t)
                    }
                }, {
                    ...
                    key: "_trackPageView",
                    value: function() {
                        if (e.includes(y, this.tagManager.pageType)) return !1;
                        var t = {
                    ...
                    value: function(e) {
                        ...
                        if ("ab_test.participated" === e.event) {
                            ...
                            if ("loc-geolocator_provider" === t && C.includes("geolocator-providers-ab-testing-experimental")) return !0
                        }
                    }
                }, {
                    key: "push",
                    value: function(t) {
                        ...
                        this._addToLocal(n.event, n.event_page_type), "virtual_page_view" === n.event && (n.event_page_referrer = this.tagManager.referrer), "shop_details.loaded" === n.event && (n.referrer = this.tagManager.referrer), n.event && (n.event_count = this._getEventCount(n.event, n.event_page_type), n.eventCount = n.event_count, n.languageSelected = (0, d.get)(this.appConfig, "googleMapLocale", "")), n.event_platform = this.getEventPlatform(), n.eventPlatform = n.event_platform, n.userIPAddress = VOLO.configuration.encryptedUserIP, this.checkABTestBlockedFlags(n) || this.dataLayer.push(n), this.avoInspector.trackSchemaFromEvent(t.event, t)
                    }
                }, {
                    key: "getEventPlatform",
                    value: function() {
                        return b || this.appConfig.platform
                    }
                }, {
                    key: "languageChanged",
                    value: function(e) {
                    ...
                    key: "trackSmartBannerEvent",
                    value: function(e, t, n) {
                        var r = {
                            event: "smart_banner." + e,
                            screenType: (0, d.get)(this.tagManager, "pageType", null),
                            userId: this.customerModel.get("id"),
                            locationCountry: this.appConfig.countryCode.toUpperCase(),
                            locationAddress: this.locationModel.address,
                            locationCity: this.locationModel.city,
                            locationLat: this.locationModel.latitude,
                            locationLon: this.locationModel.longitude,
                            locationArea: this.locationModel.postcode,
                            operatingSystemSelected: t,
                            dhhPerseusGuestId: w,
                            dhhPerseusHitId: O,
                            dhhPerseusSessionId: k,
                            deepLink: n
                        };
                        this.push(r)
                    }
                }, {
                    key: "trackBannerClick",
                    value: function(e, t) {
                        var n = {
                            event: "smart_banner.clicked",
                            screenType: (0, d.get)(this.tagManager, "pageType", null),
                            userId: this.customerModel.get("id"),
                            locationCountry: this.appConfig.countryCode.toUpperCase(),
                            locationAddress: this.locationModel.address,
                    ...
                    value: function() {
                        var t = this,
                            ...
                            l = (0, d.get)(this.appConfig, "googleMapLocale", ""),
                            f = (0, p.default)(),
                            v = (0, h.getCookiePreference)(),
                            g = (0, h.getCookieBannerDecision)(),
                            m = v || h.CookiePreferenceOptions.Functional,
                            _ = v ? g : "not selected",
                            y = {
                                ...
                                userCookiePreference: _,
                                userCookiePrivacyLevel: m
                            };
                        this.push(y), (0, c.executeOnload)(function() {
                            t.dataLayer.push(S)
                        })
                    }
                }]), t
            ...
            m = function(t) {
                function n(e) {
                    ...
                    return t.handleOpenTriggerEvent = function(e) {
                        t.componentName === f.HELP_CENTER_COMPONENTS.GLOBAL_HELP_CENTER && (e && e.preventDefault(), t.toggleContainer(!0))
                    }, t.isMobileDevice = function() {
                        return s.mobile
                    }, t.getAppVersion = function(e) {
                        var n = e.replace("B2C.", "");
                        return t.isMobileDevice() ? "mweb_" + n : "dweb_" + n
                        ...
                        t.toggleContainer(!1)
                    }, t.componentName = (0, f.getCustomerServiceComponentValue)(), t.state = {
                        isExpanded: !1,
                        isMinimized: !1
                ...
                return i(n, t), a(n, [{
                    ...
                    key: "getALANConfig",
                    value: function() {
                        return v(this, void 0, void 0, e.mark(function t() {
                            return e.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        if (!VOLO.isGuest) {
                                        ...
                                        return e.next = 3, (0, u.getAlanGuestParams)();
                                    case 3:
                                        return e.abrupt("return", e.sent);
                                    case 6:
                                        return e.next = 8, (0, u.getAlanParams)();
                                    case 8:
                                        return e.abrupt("return", e.sent);
                                    case 9:
                                    case "end":
                        ...
                        return v(this, void 0, void 0, e.mark(function t() {
                            ...
                            return e.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 3:
                                        n = e.sent, n.order_id = this.getOrderIdFromUrl(), n.app_version = this.getAppVersion(VOLO.configuration.releaseTag), this.ALANUrl = (0, d.getAlanEndpoint)(n);
                                    case 7:
    ...
    (function(e, r) {
        function o(e) {
            ...
            return t.fetch(), t.appConfig = e.appConfig, t
        }
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        var s = n(46),
            ...
            l = t.LocationModel = e.Model.extend({
                ...
                _setFromLatLng: function(e, t, n) {
                    ...
                    return this.clear({
                        silent: !0
                    }), this.locationService.setFromLatLng(parseFloat(e), parseFloat(t)).then(function(e) {
                        r.setFromGeocodingResponse(e, n), o.resolve(r)
                    }, o.reject), o.promise()
                },
                setFromGeocodingResponse: function(e, t) {
                    t && t.address && (e.address = t.address), this.set(e)
                },
    ...
    (t.ErrorBoundary = function(e) {
        function t(e) {
            ...
            return n.state = {
                error: !1,
                key: 0
            }, n.reRender = n.reRender.bind(n), n
        }
        return i(t, e), a(t, [{
            key: "componentDidCatch",
            value: function(e, t) {
                this.props.logToTrackJS && window && window.Sentry && Sentry.captureException("React failed to render:", t.componentStack, e.stack), this.props.onError && this.props.onError(e, t)
            }
        }, {
            key: "reRender",
            value: function() {
            ...
            value: function(e, t) {
                this.props.children !== e.children && this.reRender()
            }
        }, {
            key: "render",
            value: function() {
                ...
                return a(n, t), u(n, [{
                    ...
                    value: function() {
                        return s({}, c(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "events", this).call(this), {
                            "keyup #contact-information-mobile-number": (0, g.debounce)(this._validatePhoneNumber, 1e3)
                        })
                    }
                }, {
                    key: "initialize",
                    value: function() {
                        this._defaultConstraints = {
                            ...
                            "customer[birthdate]": {}
                        }, c(n.prototype.__proto__ || Object.getPrototypeOf(n.prototype), "initialize", this).apply(this, arguments), this.listenTo(this, "form-field:error", this._disableContinueButton), this.listenTo(this, "form:valid", this._enableContinueButton), this.xhrService = new v.default({
                    ...
                    value: function(t) {
                        var n = e.collectFormValues(this.el),
                            r = (0, g.get)(n, "customer[mobile_number]");
                    ...
                    value: function() {
                        var e = this;
                        this.$("#contact-information-first-name").val((0, g.unescape)(this.model.get("first_name"))), this.$("#contact-information-last-name").val((0, g.unescape)(this.model.get("last_name"))), this.$("#contact-information-email").val((0, g.unescape)(this.model.get("email"))), this.$("#contact-information-mobile-number").val((0, g.unescape)(this.model.getFullMobileNumber())), this.$("#contact-information-birthdate").val((0, g.unescape)(this.model.get("birthdate"))), (0, g.each)(this.model.get("customer_additional_fields"), function(t) {
                            e.$("#customer-information-" + t.additional_field_code).val((0, g.unescape)(t.value))
                    ...
                    value: function(e) {
                        ...
                        this.verifySmsModalView || (this.verifySmsModalView = (0, y.createInstantMobileVerificationView)({
                            ...
                            var n = (0, g.get)(e, "data.message") || (0, g.get)(e, "data.items[0].violation_messages[0]") || "Something went wrong.";
                    ...
                    value: function(e) {
                        var t = (0, g.get)(e, "data.exception_type") || (0, g.get)(e, "data.items[0].violation_messages[0]") || "general",
                            n = (0, g.get)(e, "data.message") || (0, g.get)(e, "data.items[0].violation_messages[0]") || "Something went wrong.";
                    ...
                    value: function(e) {
                        return {
                            ...
                            NEXTGEN_PROFILE_CAT4_FEEDBACK3: "already_verified",
                    ...
                    key: "_translateCustomerApiErrorMessage",
                    value: function(e) {
                        var t = {
                            "A customer with these credentials already exists.": "email_exists",
                            "This value is not a valid email address": "email_invalid"
                        };
                        return t[e] ? VOLO.profileTranslation[t[e]] : e
                    }
                }, {
                    key: "_onCustomerSaveError",
                    value: function(e, t) {
                        var n = [];
                        (0, g.each)((0, g.get)(t, "responseJSON.error.errors", []), function(e) {
                            var t = "input[name='customer[" + e.field_name + "]']",
                                r = this.$(t);
                            this._trackFormError(e), (0, g.each)((0, g.get)(e, "violation_messages", []), function(e) {
                                this.removeCurrentErrorMessage(r[0]), this.createErrorMessage(this._translateCustomerApiErrorMessage(e), r[0]), n.push(e)
                            }, this)
    ...
    var a = function() {
        ...
        c = function(e) {
            ...
            return i(t, e), a(t, [{
                ...
                key: "supportedErrors",
                value: function() {
                    return ["ApiInvalidParameterException", "ApiObjectDoesNotExistException", "ApiCartConflictWithProductException"]
                }
            }, {
                key: "initialize",
                value: function() {
                    (0, u.bindAll)(this), this.template = (0, u.template)($("#template-cart-invalid-products-list").html()), this.$el.modal({
                        show: !1,
                        backdrop: "static"
                    })
                }
                ...
                value: function(e) {
                    if (!e || !1 !== e.showErrorModal) {
                        ...
                        e && e.ProductInvalidForVendor && (n = this.template({
                            invalidProducts: (0, u.map)(e.invalidProducts, function(t) {
                                return (t.name || t.variation_name) && (t.name || t.variation_name).concat(": ", (0, u.map)(e.invalidProducts, function(e) {
                                    return e.products && e.products.map(function(e) {
                                        return e.variation_name + ", " + e.toppings.map(function(e) {
                                            return e.name
                                        }).join(" ,")
                                    }).join(" ").concat(e.toppings && e.toppings.map(function(e) {
                                        return e.name
                                    }))
                                }))
                            })
    ...
    var r = n(425),
        ...
        p = [d.setupUserHeaderView, i.setupHeaderAnimation, u.setupBannersView, o.default, a.setupWalletWidget];
    t.default = function(e) {
        (0, s.validateComponentDependencies)(e, "services.gtmService", "services.gtmUserProfileTracker", "services.cartDataStore", "services.locationService");
        var t = f(e) ? p.concat(c.setupCorporateHeaderView) : p,
            n = (0, s.setupDependencies)(e, t);
        return n.views.userHeaderView && n.views.userHeaderView.render(), $("body").hasClass("show-change-password-modal") && n.views.loginButtonView.showModalResetPassword(), n.views.corporateHeaderView && n.views.corporateHeaderView.render(), n.views.headerAnimation.init(), n.views.bannersView.render(), n.views.languageSwitchView = (0, l.createLanguageSwitchView)({
            el: $(".language-switch"),
    ...
    (function(e, r) {
        ...
        function i(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : VOLO.configuration,
                n = e.load();
            return VOLO.CartModel = VOLO.CartModel || new _(n, {
                parse: !0,
                dataStore: e,
                appConfig: t
            }), VOLO.CartModel
        ...
        var _ = t.CartModel = e.Model.extend({
            defaults: {
                has_seen_upsell: !1,
                has_done_upsell: !1,
            ...
            _getInvalidProducts: function(e) {
                var t = [];
                return e.forEach(function(e) {
                    var n = r.cloneDeep(e);
                    n.products = n.products ? n.products : [];
                    var o = n.is_available,
                        i = n.toppings.filter(function(e) {
                            return !e.is_available
                        }),
                        s = n.products.filter(function(e) {
                            return !e.is_available || e.toppings.some(function(e) {
                                return !e.is_available
                            })
                        });
                    (!o || i.length > 0 || s.length > 0) && t.push(a({}, n, {
                        toppings: i,
                        products: s.map(function(e) {
                            return a({}, e, {
                                toppings: e.toppings.filter(function(e) {
                                    return !e.is_available
                                })
                            })
                        })
            ...
            _removeInvalidProducts: function(e) {
                return e.filter(function(e) {
                    return e.is_available && (0 === e.toppings.length || !e.toppings.some(function(e) {
                        return !e.is_available
                    })) && (!e.products || 0 === e.products.length || !e.products.some(function(e) {
                        return !e.is_available || 0 === !e.toppings.length || e.toppings.some(function(e) {
                            return !e.is_available
                        })
                    }))
            ...
            parse: function(e, t) {
                ...
                if (this.dataStore = this.dataStore || t.dataStore, this.appConfig = this.appConfig || t.appConfig, r.isUndefined(this.vendorCarts) && (this.vendorCarts = new c.default([], {
                    ...
                    n.loyalty || (n.loyalty = {
                        ...
                        var o = this._getInvalidProducts(e.products);
                        if (this.getCart(e.vendor_id).invalid_products = o, o && o.length > 0) {
                            var i = {
                                ProductInvalidForVendor: !0,
                                invalidProducts: o
                            };
                            r.isObject(this.cartErrorModalView) && this.cartErrorModalView.unbind(), this.cartErrorModalView = new m.default({
                                el: ".modal-error-cart",
                                vendorId: e.vendor_id
                            }), this.cartErrorModalView.displayError(i)
                        }
                        e.products = e.products ? this._removeInvalidProducts(e.products) : [], e.products = e.products.map(function(e) {
                        ...
                        a.reset(), e.products.forEach(function(e) {
                            ...
                            var t = new h.default({
                                ...
                                packaging_price: e.packaging_price,
                                code: e.code,
                                ...
                                quantity_auto_added: e.quantity_auto_added,
                                tags: e.tags ? e.tags : [],
                                products: e.products ? e.products : []
                            });
                            a.push(t)
                        }), 0 === a.toJSON().length && 0 === e.products.length && a.trigger("update"), delete e.products
            ...
            return o(e, [{
                ...
                value: function() {
                    var e = (0, a.default)(".header"),
                        t = (0, a.default)("body"),
                        n = t.hasClass("home"),
                        r = (n && ((0, a.default)(".hero-section").length < 1 || (0, a.default)(".hero-section-new").length), t.hasClass("restaurants") && ((0, a.default)(".hero-section").length > 0 || (0, a.default)(".hero-section-new").length > 0)),
                        o = n || r,
                        i = void 0,
                        s = void 0;
                    !t.hasClass("restaurants") || (0, a.default)(".hero-section").length > 0 && (0, a.default)(".hero-section-new").length > 0 || (e.removeClass("header-no-bg"), e.addClass("header--white")), this.pageScrolledDownForHeaderChange() ? (e.addClass("header--white"), o && e.removeClass("header-no-bg")) : (i = e.hasClass("header--white"), s = e.hasClass("header-no-bg"), i && !e.hasClass("header-small") && e.removeClass("header--white"), i && o && e.removeClass("header--white"), s || !o || e.hasClass("corporate") || e.addClass("header-no-bg"))
                }
            }, {
                key: "changeHeader",
                value: function() {
    ...
    ! function(t, n) {
        ...
        return function(e) {
            ...
            var y = ["padding", "margin", "width", "max-width", "none"],
                ...
                w = function(e) {
                    b.queue <= 0 && (b.scroll = !1, G(), z()), M(e), b.queue++
                },
                O = function(e) {
                    b.queue > 0 && b.queue--, b.queue <= 0 && (b.scroll = !0, U(), K()), A(e)
                },
                k = function() {
                    return b.scroll
                },
                ...
                S = function(e) {
                    ...
                    if (i(e)) {
                        ...
                        t ? k() || (e.style.overflowY = e.dataset.scrollLockSavedOverflowYProperty) : e.style.overflowY = "scroll";
                        var r = P(e);
                ...
                x = function(e) {
                    if (e)
                        if (-1 !== y.indexOf(e)) b.fillGapMethod = e, B();
                        else {
                            var t = y.join(", ");
    ...
    (function(e, r) {
        ...
        t.default = e.Model.extend({
            ...
            initialize: function(e, t) {
                if (r.bindAll(this), this.products = new u.default, this.invalid_products = new u.default, this.timeoutReference = null, this._cart = t.cart, this.appConfig = t.cart.appConfig, this.timezone = t.vendorTimezone || this.appConfig.timeZone, this.isGroupOrderSplitEnabled = (0, f.default)(), this.isReactCartEnabled = (0, v.get)(this.appConfig.features.flags, "react-cart", !0), this.isNewCartAPI = !0, this.groupOrderCalculator = new l.default(2, VOLO.customer.get("id"), VOLO.isVatIncludedInProductPrice), this.appConfig && this.appConfig.apiKey === VOLO.configuration.apiKeyCorporate) {
            ...
            isNewGroupOrderFlow: function() {
                ...
                return e && !0 === e["react-cart"] && !0 === e.groupie
            },
            isPreorder: function() {
            ...
            _removeInvalidProducts: function(e) {
                return e.filter(function(e) {
                    return e.is_available && (0 === e.toppings.length || !e.toppings.some(function(e) {
                        return !e.is_available
                    })) && (0 === e.products.length || !e.products.some(function(e) {
                        return !e.is_available || 0 === !e.toppings.length || e.toppings.some(function(e) {
                            return !e.is_available
                        })
                    }))
            ...
            _update: function(e) {
                ...
                var s = [];
                if (this.invalid_products && this.invalid_products.length > 0 && (s = s.concat(this.invalid_products)), s && s.length > 0) {
                    var u = {
                        ProductInvalidForVendor: !0,
                        invalidProducts: s
                    };
                ...
                n || this.isReactCartEnabled && !p.isCheckoutPage || (this.trigger("cart:ready"), this.trigger("cart:isValid"), this.trigger("cart:render"), this.backupCart())
            },
            ...
            _restoreUpsellAndProductMasterCategoryIds: function(e) {
                ...
                return r.isUndefined(e.vendor_cart[0]) || this.get("has_seen_upsell") || this.get("has_done_upsell") ? e : (e.vendor_cart[0].has_seen_upsell = this.get("has_seen_upsell"), e.vendor_cart[0].has_done_upsell = this.get("has_done_upsell"), e.vendor_cart[0].has_accepted_alcohol = this.get("has_accepted_alcohol"), e.vendor_cart[0].products = r.map(e.vendor_cart[0].products, function(e) {
                    var n = void 0;
                    if (n = e.products && (0, v.isArray)(e.products) ? t.products.findWhere({
                            product_variation_id: e.product_variation_id,
                            products: [].concat(i(e.products.map(function(e) {
                                return {
                                    variation_id: e.variation_id
                                }
                            })))
                        }) : t.products.findWhere({
                            product_variation_id: e.product_variation_id
                        })) {
                        e.name = n.get("name"), e.product_id = n.get("product_id"), e.id = n.get("product_id"), e.master_category_id = n.get("master_category_id"), e.is_alcoholic_item = n.get("is_alcoholic_item"), e.is_prepacked_item = n.get("is_prepacked_item"), e.sold_out_options = n.get("sold_out_options"), e.sold_out_option = n.get("sold_out_option"), e.sold_out_option_updated = n.get("sold_out_option_updated"), e.exclude_dish_information = n.get("exclude_dish_information"), e.menu_id = n.get("menu_id"), e.menu_category_id = n.get("menu_category_id"), e.packaging_charge = n.get("packaging_charge"), e.packaging_price = n.get("packaging_price"), e.price = n.get("price"), e.original_price = n.get("original_price"), e.product_variations = n.get("product_variations"), e.code = n.get("code"), e.menu_category_code = n.get("menu_category_code"), e.variation_code = n.get("variation_code"), e.tags = n.get("tags");
                        var r = n.get("products");
                        e.products = [].concat(i(r.map(function(t) {
                            var n = e.products.find(function(e) {
                                return (0, g.isSimilarProductsWithoutQuantity)(e, t)
                            });
                            return a({}, t, {
                                is_available: n && n.is_available || !1,
                                toppings: t.toppings.map(function(e) {
                                    var t = n.toppings.find(function(t) {
                                        return t.id === e.id
                                    });
                                    return a({}, e, {
                                        is_available: t && t.is_available || !1
                                    })
                                })
                            })
                        })))
            ...
            _handleCartErrors: function(e) {
                var t, n, o = r.get(e, "error.errors", a({}, e)),
                    i = {};
                ...
                return r.extend(o, this.attributes, {
                    products: this.attributes.products.map(function(t) {
                        ...
                        var i = {
                            ...
                            packaging_price: t.packaging_price,
                            image: t.image,
                            price: o.price,
                            ...
                            tags: t.tags ? t.tags : [],
                            products: r.cloneDeep(t.products)
                        };
    ...
    n(258), n(211), n(259), n(289), n(297), n(299), n(300), n(213), n(269), n(6), n(266), n(83), n(301), n(7), n(302), e.exports = n(303)
}, function(e, t, n) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    (function(t) {
        ! function(t) {
            ...
            function c(e, t, n) {
                ...
                return function(i, a) {
                    ...
                    for (n.method = i, n.arg = a;;) {
                        ...
                        var c = r(e, t, n);
                        if ("normal" === c.type) {
                            if (o = n.done ? E : P, c.arg === M) continue;
                            return {
                                value: c.arg,
                                done: n.done
                            }
                        }
                        "throw" === c.type && (o = E, n.method = "throw", n.arg = c.arg)
                    }
                }
            }
            ...
            function l(e, t) {
                ...
                if (n === g) {
                    if (t.delegate = null, "throw" === t.method) {
                        if (e.iterator.return && (t.method = "return", t.arg = g, l(e, t), "throw" === t.method)) return M;
                ...
                var i = o.arg;
                return i ? i.done ? (t[e.resultName] = i.value, t.next = e.nextLoc, "return" !== t.method && (t.method = "next", t.arg = g), t.delegate = null, M) : i : (t.method = "throw", t.arg = new TypeError("iterator result is not an object"), t.delegate = null, M)
            }
            ...
            var L = Object.getPrototypeOf,
                I = L && L(L(h([])));
            I && I !== m && _.call(I, b) && (A = I);
            var j = a.prototype = o.prototype = Object.create(A);
            i.prototype = j.constructor = a, a.constructor = i, a[O] = i.displayName = "GeneratorFunction", C.isGeneratorFunction = function(e) {
                var t = "function" == typeof e && e.constructor;
                return !!t && (t === i || "GeneratorFunction" === (t.displayName || t.name))
            }, C.mark = function(e) {
                return Object.setPrototypeOf ? Object.setPrototypeOf(e, a) : (e.__proto__ = a, O in e || (e[O] = "GeneratorFunction")), e.prototype = Object.create(j), e
            }, C.awrap = function(e) {
                return {
                    __await: e
                }
                ...
                finish: function(e) {
                    for (var t = this.tryEntries.length - 1; t >= 0; --t) {
                        ...
                        if (n.finallyLoc === e) return this.complete(n.completion, n.afterLoc), f(n), M
                    }
                },
                catch: function(e) {
                    for (var t = this.tryEntries.length - 1; t >= 0; --t) {
    ...
    var o = n(0),
        ...
        p = n(9),
        h = r(p);
    t.setupWalletWidget = function(e) {
        if (!VOLO.walletWidgetProps) return e;
        var t = VOLO.walletWidgetProps.translations,
            n = new h.default({
                appConfig: e.config,
                $: $
            }),
            r = (0, f.createWalletWidgetProvider)(n),
            o = function(e) {
                return i.default.createElement(u.ErrorBoundary, null, function(n) {
                    return n.error ? null : i.default.createElement(l.default.Provider, {
                        value: t
                    }, i.default.createElement(d.WalletWidget, {
                        inAccountMenu: e.includes("account-menu"),
                        provider: r
                    }))
                })
            };
        return ["wallet-widget-account-menu", "wallet-widget-home-page"].forEach(function(e) {
            document.getElementById(e) && s.default.render(o(e), document.getElementById(e))
        }), e
    }
}, function(e, t, n) {
    "use strict";
    (function(e) {
        ...
        t.WalletWidget = function(t) {
            var n = t.inAccountMenu,
                r = t.provider,
                s = VOLO,
                f = s.isGuest,
                p = (0, i.useState)(),
                ...
                v = h[0],
                g = h[1],
                m = Boolean(f || v && v.is_wallet_enabled_for_geid),
                _ = function() {
                    location.href = "/pandapay"
                };
            (0, i.useEffect)(function() {
                ! function() {
                    d(void 0, void 0, void 0, e.mark(function t() {
                        var n;
                        return e.wrap(function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    return e.next = 2, r.getWalletWidget(VOLO.languageId, VOLO.locale);
                                case 2:
                                    n = e.sent, g(n);
                                case 4:
                                case "end":
            ...
            var y = m ? a.default.createElement("div", {
                className: "wallet-widget"
            }, a.default.createElement("div", {
                className: "wallet-widget__main",
                "data-testid": "wallet-widget-main",
                onClick: _
            }, a.default.createElement(l.WalletWidgetContent, {
                data: v
            })), !f && v && v.actions && v.actions.map(function(e, t) {
                return a.default.createElement(c.WalletWidgetAction, {
                    key: "widget-action-" + t,
                    action: e
                })
            })) : null;
            return y ? n ? a.default.createElement("div", {
                className: "wallet-widget-wrapper"
            }, y) : y : n ? a.default.createElement("a", {
                href: "/pandapay",
                className: "header_account__dropdown__link js-pandapay"
            }, a.default.createElement(u.default.Text, {
                tKey: "NEXTGEN_WALLET_BRAND_NAME"
            })) : null
        }
    }).call(t, n(3))
}, function(e, t, n) {
    ...
    var o = n(5),
        ...
        u = n(15),
        c = r(u);
    t.WalletWidgetAction = function(e) {
        var t = e.action,
            n = function() {
                t.is_disabled || (location.href = t.weblink)
            };
        return s.default.createElement("div", {
            className: (0, i.default)("wallet-widget__action", {
                disabled: t.is_disabled
            }),
            "data-testid": "wallet-widget-action-" + t.label,
            onClick: n
        }, s.default.createElement("div", null, s.default.createElement("img", {
            alt: "Action Icon",
            src: t.icon_image_url
        })), s.default.createElement("span", null, s.default.createElement(c.default.Text, {
            tKey: t.label
        })))
    }
}, function(e, t, n) {
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.WalletWidgetContent = void 0;
    var o = n(0),
        i = r(o),
        a = n(15),
        s = r(a),
        u = n(601);
    t.WalletWidgetContent = function(e) {
        var t = e.data,
            n = VOLO,
            r = n.formatCurrency,
            o = n.isGuest;
        if (o || t && null === t.balance || t && t.is_onboarding) {
            var a = "NEXTGEN_WALLET_HOMESCREEN_LOGIN_TITLE",
                c = "NEXTGEN_WALLET_HOMESCREEN_LOGIN_DESCRIPTION";
            return t && null === t.balance && (c = "NEXTGEN_WALLET_HOMESCREEN_ERROR_DESCRIPTION"), t && t.is_onboarding && (a = "NEXTGEN_WALLET_HOMESCREEN_ONBOARDING_TITLE", c = t.onboarding_label ? t.onboarding_label : "NEXTGEN_WALLET_HOMESCREEN_ONBOARDING_DESCRIPTION"), i.default.createElement(i.default.Fragment, null, i.default.createElement("div", {
                className: "wallet-widget__main__top"
            }, i.default.createElement("div", null, i.default.createElement("span", null, i.default.createElement(s.default.Text, {
                tKey: a
            })), !o && i.default.createElement(u.WalletWidgetLogo, {
                imageUrl: t.pandapay_icon_url
            }))), i.default.createElement("div", {
                className: "wallet-widget__main__bottom"
            }, i.default.createElement("span", null, i.default.createElement(s.default.Text, {
                tKey: c
            }))))
        }
        return i.default.createElement(i.default.Fragment, null, i.default.createElement("div", {
            className: "wallet-widget__main__top"
        }, i.default.createElement(u.WalletWidgetLogo, {
            imageUrl: t.pandapay_icon_url
        }), t.has_notification && i.default.createElement("img", {
            className: "wallet-widget__notification-icon",
            "data-testid": "wallet-widget-notification-icon",
            alt: "Notification Icon",
            src: t.notification_icon_url
        })), i.default.createElement("div", {
            className: "wallet-widget__main__bottom"
        }, i.default.createElement("span", {
            className: t.is_balance_active ? "active" : "inactive"
        }, r(t.balance.amount)), t.has_warning && i.default.createElement("img", {
            alt: "Warning Icon",
            src: "/img/checkout/ic-warning-filled.svg"
        })))
    }
}, function(e, t, n) {
    "use strict";
    ...
    Object.defineProperty(t, "__esModule", {
        value: !0
    }), t.WalletWidgetLogo = void 0;
    var o = n(0),
        i = r(o),
        a = n(15),
        s = r(a);
    t.WalletWidgetLogo = function(e) {
        var t = e.imageUrl;
        return t ? i.default.createElement("img", {
            className: "wallet-widget__logo",
            alt: "Wallet Logo",
            src: t
        }) : i.default.createElement("span", {
            className: "wallet-widget__brand-name"
        }, i.default.createElement(s.default.Text, {
            tKey: "NEXTGEN_WALLET_BRAND_NAME"
        }))
    }
}, function(e, t, n) {
    ...
    (function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.WalletWidgetProvider = t.createWalletWidgetProvider = void 0;
        var o = function() {
                function e(e, t) {
                    for (var n = 0; n < t.length; n++) {
                        var r = t[n];
            ...
            s = (t.createWalletWidgetProvider = function(e) {
                return new s(function(t) {
                    var n = e.createAPIUrl("wallet/home-screen");
                    return (0, i.jqxhr2Promise)(e.send(Object.assign({
                        url: n
                    }, t)))
                })
            }, t.WalletWidgetProvider = function() {
                function t(e) {
                    r(this, t), this.send = e
                }
                return o(t, [{
                    key: "getWalletWidget",
                    value: function(t, n) {
                        return a(this, void 0, void 0, e.mark(function r() {
                            var o, i;
                            return e.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        return o = void 0, e.prev = 1, e.next = 4, this.send({
                                            data: {
                                                language_id: t,
                                                locale: n
                                            }
                                    ...
                                    case 4:
                                        ...
                                        break;
                                    case 8:
                                        e.prev = 8, e.t0 = e.catch(1), o = void 0;
                                    case 11:
    ...
    (function(e) {
        ...
        t.setupBannersView = function(e) {
            ...
            var t = v(VOLO.jsonVendorLocation, VOLO.jsonCityLocation, e.models.locationModel, VOLO.components.services.locationService.getAddressFormatter(), e.config, e.services.locationService),
                n = g({
                    locationModel: t,
                    appConfig: e.config,
    ...
    (function(e, r) {
        ...
        var i = n(21),
            a = n(291),
            s = n(607),
            u = ["home", "restaurants--no-address", "menu", "cuisine-page", "static-page"],
            c = t.SmartphoneBannerView = e.View.extend({
                events: {
                    "click .banner-close-button": "handleCloseButtonClick",
                    "click .banner-view-button": "sendGtmSmartBannerClick"
                },
                initialize: function(e) {
                ...
                show: function() {
                    this.$body.addClass(this.showBannerClass), this.$body.addClass("show-banner"), this.sendGtmSmartBannerView(), window.blazy && window.blazy.revalidate()
                },
                hide: function() {
                    Cookies.set(this.hideCookie, "1", {
                        expires: 90
                    }), this.$body.removeClass(this.showBannerClass), this.trigger(this.hideEvent), this.unbind()
                },
                handleCloseButtonClick: function() {
                    this.hide(), this.gtmService.push({
                        event: "gtm.click",
                        class: "icon-cancel"
                    })
                },
                sendGtmSmartBannerView: function() {
                    var e = (0, s.getBannerDeepLinkAndPlatform)(this.$body),
                        t = e.platformName,
                        n = e.deepLink;
                    this.gtmService.trackSmartBannerEvent("shown", t, n)
                },
                sendGtmSmartBannerClick: function() {
                    var e = (0, s.getBannerDeepLinkAndPlatform)(this.$body),
                        t = e.platformName,
                        n = e.deepLink;
                    this.gtmService.trackSmartBannerEvent("clicked", t, n)
                },
                isHuawei: function() {
    ...
    t.getBannerDeepLinkAndPlatform = function(e) {
        var t = e.hasClass("show-android-banner"),
            n = e.hasClass("show-ios-banner"),
            r = e.hasClass("show-huawei-banner"),
            o = "",
            i = "",
            a = "";
        t ? (o = e.find(".banner.android-banner a").attr("href"), a = "AND") : n ? (o = e.find(".banner.ios-banner a").attr("href"), a = "IOS") : r && (o = e.find(".banner.ios-huawei a").attr("href"), a = "HUA");
        try {
            i = new URL(o).searchParams.get("adjust_deeplink")
        } catch (e) {}
        return {
            deepLink: i,
            platformName: a
    ...
    var a = function() {
        ...
        v = function(e) {
            ...
            h() && (t += p.MODAL_HASHES.CART), (0, s.goToUrl)(t)
        },
        g = function(e) {
            function t(e) {
                r(this, t);
                ...
                return n.reset = function() {
                    ...
                    var e = (0, f.getGroupOrderUrl)(),
                        t = (0, f.extractPathnameFromUrl)(e);
                    if (t) {
                        var r = "" + window.location.origin + t;
    ...
    var h = function() {
        ...
        return a(e, [{
            ...
            value: function(e, t, n, r, o, a, s, u, p) {
                ...
                u && (v.pageType = u), p && (v.crossSellRequestId = p), this.gtmService.push(v)
            }
        }, {
                ...
                return o(t, [{
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        f = e.sent, _ = Object.assign({
                                            ...
                                            loyaltyRedeemedValue: g,
                                            loyaltyEarnedValue: m
                                        }), (0, a.getGroupOrderId)() && (_.pageUrlPath = window.location.href, _.pageType = "checkout", _.groupOrderUserType = "host", _.groupOrderUserCount = (0, a.getGroupOrderParticipantsCountFromView)("checkout")), void 0 !== v && (_.walletBalance = v), this.gtmService.push(_);
                                    case 7:
                                    case "end":
                                        return e.stop()
                                }
                                ...
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        f = e.sent, g = Object.assign({
                                            ...
                                            deliveryProvider: p,
                                            tokenizedPayment: h
                                        }), (0, a.getGroupOrderId)() && (g.pageUrlPath = window.location.href, g.pageType = "checkout", g.groupOrderUserType = "host", g.groupOrderUserCount = (0, a.getGroupOrderParticipantsCountFromView)("checkout")), void 0 !== v && (g.walletBalance = v), this.gtmService.push(g);
                                    case 7:
                                    case "end":
                                        return e.stop()
                                }
                            ...
                            return e.wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    ...
                                    case 2:
                                        ...
                                        }), (0, a.getGroupOrderId)() && (g.pageUrlPath = window.location.href, g.pageType = "checkout", g.groupOrderUserType = "host", g.groupOrderUserCount = (0, a.getGroupOrderParticipantsCountFromView)("checkout")), void 0 !== p && (g.walletBalance = p), this.gtmService.push(g);
                                    case 7:
                                    case "end":
                                        return e.stop()
                                }
                    ...
                    value: function(e) {
                        var t = e.location,
                            ...
                            v = e.orderPaymentMethodDefault,
                            g = e.deliveryProvider,
                            m = e.isLoggedIn,
                            _ = Object.assign({
        ...
        E = function(e) {
            ...
            return a(t, e), s(t, [{
                ...
                value: function() {
                    ...
                    }, this.address = null, this.spinner = null, this.customerModel = e.customerModel, this.facebookService = e.facebookService, this.gtmService = e.gtmService, this.gtmUserProfileTracker = e.gtmUserProfileTracker, this.templateLogin = (0, k.template)($("#template-login").html()), this.templateRegistration = (0, k.template)($("#template-registration").html()), this.templateResetPassword = (0, k.template)($("#template-reset-password").html()), this.templateForgotPassword = (0, k.template)($("#template-forgot-password").html())
                }
            }, {
                ...
                value: function() {
                    ...
                    (0, k.each)(e, this._safeUnbindView), this.stopListening(), this.undelegateEvents(), this.facebookButtonView && this.facebookButtonView.unbind()
                }
            }, {
                ...
                value: function() {
                    ...
                    return this.$el.modal(), this.$(".modal-content").html(this.templateForgotPassword), this._safeUnbindView(this._forgotPasswordValidationView), this._forgotPasswordValidationView = new g.default({
                ...
                value: function(e) {
                    ...
                    $(r).addClass("modal-content--loading"), o.spin(r), t.find("button").prop("disabled", !0), $.ajax({
                        ...
                        success: function() {
                            window.location.replace("/login?step=login")
                        }.bind(this),
                        error: function(e) {
                            if ((0, C.isPerimeterXEnabled)(e)) return void(0, C.pxCaptchaHandler)({
                ...
                value: function() {
                    var e = new l.default,
                        ...
                        o = void 0;
                    return (0, P.isFeatureEnabled)(C.perimeterXFeatureFlag) ? this._disableLoginButton() : (this._disableForm(), this._enableSpinner()), o = e.login(t, {}, n, r), o.then(this._loginSuccess.bind(this), this._loginFail.bind(this)), !1
                }
            }, {
                key: "_loginSuccess",
                value: function(e) {
                ...
                value: function(e) {
                    ...
                    if ((0, T.is2FAError)(e)) {
                    ...
                    } else if ((0, C.isPerimeterXEnabled)(e))(0, C.pxCaptchaHandler)({
                        ...
                        var o = (0, k.trim)($(e.responseText).find(".modal-error-message").text());
                        this.gtmService.push({
                            event: "login_failure",
                            event_login_type: "email",
                ...
                value: function() {
                    var e = new l.default,
                        ...
                        n = this.address ? this.address.toJSON() : {},
                        r = void 0;
                    return (0, P.isFeatureEnabled)(C.perimeterXFeatureFlag) ? this._disableRegisterButton() : (this._disableForm(), this._enableSpinner()), r = e.register(t, n), r.then(this._registerSuccess.bind(this), this._registerFail.bind(this)), !1
                }
            }, {
                ...
                value: function(e) {
                    var t = this;
                    if ((0, C.isPerimeterXEnabled)(e))(0, C.pxCaptchaHandler)({
                        ...
                        var n = (0, k.trim)($(e.responseText).find(".form__error-message").text());
                        this.gtmService.push({
                ...
                key: "_bindLoginView",
                value: function() {
                    this._safeUnbindView(this._loginValidationView), this._loginValidationView = new g.default({
                        el: this.$(".login-form"),
                ...
                value: function() {
                    var e = this;
                    this.facebookButtonView && this.facebookButtonView.unbind(), this.facebookButtonView = new O.default({
                        ...
                        var t = (0, k.trim)(e.$(".facebook-button-wrapper").data("msg-no-email"));
                        e.gtmService.push({
                            event: "login_failure",
                            event_login_type: "facebook",
                ...
                value: function() {
                    this._safeUnbindView(this._resetPasswordValidationView), this._resetPasswordValidationView = new g.default({
        ...
        return function(e) {
            ...
            var r = n(2),
                ...
                f = function() {
                    function e(t) {
                        var n = this;
                        if (l.isValueEmpty(t.env) ? this.environment = r.AvoInspectorEnv.Dev : -1 === Object.values(r.AvoInspectorEnv).indexOf(t.env) ? this.environment = r.AvoInspectorEnv.Dev : this.environment = t.env, l.isValueEmpty(t.apiKey)) throw new Error("[Avo Inspector] No API key provided. Inspector can't operate without API key.");
                        if (this.apiKey = t.apiKey, l.isValueEmpty(t.version)) throw new Error("[Avo Inspector] No version provided. Many features of Inspector rely on versioning. Please provide comparable string version, i.e. integer or semantic.");
                        this.version = t.version, this.environment === r.AvoInspectorEnv.Dev ? (e._batchSize = 1, e._shouldLog = !0) : (e._batchSize = 30, e._batchFlushSeconds = 30, e._shouldLog = !1), e.avoStorage = new u.AvoStorage(e._shouldLog);
                        var o = new s.AvoNetworkCallsHandler(this.apiKey, this.environment.toString(), t.appName || "", this.version, d);
                        this.avoBatcher = new a.AvoBatcher(o), this.sessionTracker = new i.AvoSessionTracker(this.avoBatcher), this.avoDeduplicator = new c.AvoDeduplicator;
                        try {
                            "undefined" != typeof window && window.addEventListener("load", function() {
                                n.sessionTracker.startOrProlongSession(Date.now())
                            }, !1)
                        } catch (e) {}
                    }
                    return Object.defineProperty(e, "batchSize", {
                        get: function() {
                            return this._batchSize
                        },
                        set: function(e) {
                            this._batchSize = e < 1 ? 1 : e
                        },
                        enumerable: !1,
                        configurable: !0
                    }), Object.defineProperty(e, "batchFlushSeconds", {
                        get: function() {
                            return this._batchFlushSeconds
                        },
                        enumerable: !1,
                        configurable: !0
                    }), Object.defineProperty(e, "shouldLog", {
                        get: function() {
                        ...
                        enumerable: !1,
                        configurable: !0
                    }), e.prototype.trackSchemaFromEvent = function(t, n) {
                        try {
                            if (this.avoDeduplicator.shouldRegisterEvent(t, n, !1)) {
                                e.shouldLog;
                                var r = this.extractSchema(n, !1);
                                return this.trackSchemaInternal(t, r, null, null), r
                            }
                            return e.shouldLog, []
                        } catch (e) {
                            return []
                        }
                    }, e.prototype._avoFunctionTrackSchemaFromEvent = function(t, n, r, o) {
                        try {
                            if (this.avoDeduplicator.shouldRegisterEvent(t, n, !0)) {
                                e.shouldLog;
                                var i = this.extractSchema(n, !1);
                                return this.trackSchemaInternal(t, i, r, o), i
                            }
                            return e.shouldLog, []
                        } catch (e) {
                            return []
                        }
                    }, e.prototype.trackSchema = function(t, n) {
                        try {
                            this.avoDeduplicator.shouldRegisterSchemaFromManually(t, n) ? (e.shouldLog, this.trackSchemaInternal(t, n, null, null)) : e.shouldLog
                        } catch (e) {}
                    }, e.prototype.trackSchemaInternal = function(e, t, n, r) {
                        try {
                            this.sessionTracker.startOrProlongSession(Date.now()), this.avoBatcher.handleTrackSchema(e, t, n, r)
                        } catch (e) {}
                    }, e.prototype.enableLogging = function(t) {
                        e._shouldLog = t
                    }, e.prototype.extractSchema = function(t, n) {
                        void 0 === n && (n = !0);
                        try {
                            return this.sessionTracker.startOrProlongSession(Date.now()), this.avoDeduplicator.hasSeenEventParams(t, !0) && n && e.shouldLog, e.shouldLog, o.AvoSchemaParser.extractSchema(t)
                        } catch (e) {
                            return []
                        }
                    }, e.prototype.setBatchSize = function(t) {
                        e._batchSize = t
                    }, e.prototype.setBatchFlushSeconds = function(t) {
                        e._batchFlushSeconds = t
                    }, e._batchSize = 30, e._batchFlushSeconds = 30, e._shouldLog = !1, e
                }();
            t.AvoInspector = f
        }, function(e, t, n) {
            "use strict";
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoInspectorEnv = void 0, t.AvoInspectorEnv = {
                Prod: "prod",
                Dev: "dev",
                Staging: "staging"
            }
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoSchemaParser = void 0;
            var r = function(e) {
                    return "[object Array]" === Object.prototype.toString.call(e)
                },
                o = function() {
                    function e() {}
                    return e.extractSchema = function(e) {
                        var t = this;
                        if (null == e) return [];
                        var n = function(e) {
                            if (r(e)) {
                                ...
                                for (var a in e)
                                    if (e.hasOwnProperty(a)) {
                                        var s = e[a],
                                            u = {
                                                propertyName: a,
                                                propertyType: t.getPropValueType(s)
                                            };
                                        "object" == typeof s && null != s && (u.children = n(s)), i.push(u)
                                    } return i
                            }
                            return t.getPropValueType(e)
                        };
                        return n(e)
                    }, e.removeDuplicates = function(e) {
                        var t = {
                                boolean: {},
                                number: {},
                                string: {}
                    ...
                    }, e.getPropValueType = function(e) {
                        var t = typeof e;
                        return null == e ? "null" : "string" === t ? "string" : "number" === t || "bigint" === t ? (e + "").indexOf(".") >= 0 ? "float" : "int" : "boolean" === t ? "boolean" : "object" === t ? r(e) ? "list" : "object" : "unknown"
                    }, e
                }();
            t.AvoSchemaParser = o
        }, function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoSessionTracker = void 0;
            var r = n(1),
                o = n(0),
                i = function() {
                    function e(e) {
                        this._lastSessionTimestamp = null, this._sessionLengthMillis = 3e5, this.avoBatcher = e
                    }
                    return Object.defineProperty(e, "sessionId", {
                        get: function() {
                            if (null === e._sessionId) {
                                if (!o.AvoInspector.avoStorage.isInitialized()) return "unknown";
                                var t = null;
                                try {
                                    t = o.AvoInspector.avoStorage.getItem(e.idCacheKey)
                                } catch (e) {}
                                e._sessionId = null == t ? this.updateSessionId() : t
                            }
                            return e._sessionId
                        },
                        enumerable: !1,
                        configurable: !0
                    }), Object.defineProperty(e.prototype, "lastSessionTimestamp", {
                        get: function() {
                            if (null === this._lastSessionTimestamp || 0 === this._lastSessionTimestamp) {
                                var t = o.AvoInspector.avoStorage.getItem(e.lastSessionTimestampKey);
                                null != t ? (this._lastSessionTimestamp = t, isNaN(this._lastSessionTimestamp) && (this._lastSessionTimestamp = 0)) : this._lastSessionTimestamp = 0
                            }
                            return this._lastSessionTimestamp
                        },
                        enumerable: !1,
                        configurable: !0
                    }), Object.defineProperty(e.prototype, "sessionLengthMillis", {
                        get: function() {
                            return this._sessionLengthMillis
                        },
                        enumerable: !1,
                        configurable: !0
                    }), e.prototype.startOrProlongSession = function(t) {
                        var n = this;
                        o.AvoInspector.avoStorage.runAfterInit(function() {
                            t - n.lastSessionTimestamp > n._sessionLengthMillis && (e.updateSessionId(), n.avoBatcher.handleSessionStarted()), n._lastSessionTimestamp = t, o.AvoInspector.avoStorage.setItem(e.lastSessionTimestampKey, n._lastSessionTimestamp)
                        })
                    }, e.updateSessionId = function() {
                        e._sessionId = r.default.newGuid();
                        try {
                            o.AvoInspector.avoStorage.setItem(e.idCacheKey, e.sessionId)
                        } catch (e) {}
                        return e._sessionId
                    }, Object.defineProperty(e, "lastSessionTimestampKey", {
                        get: function() {
                            return "AvoInspectorSessionTimestamp"
                        },
                        enumerable: !1,
                        configurable: !0
                    }), Object.defineProperty(e, "idCacheKey", {
                        get: function() {
            ...
            t.AvoSessionTracker = i
        }, function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.deepEquals = t.isValueEmpty = void 0, t.isValueEmpty = function(e) {
                return null == e || 0 == e.trim().length
            }, t.deepEquals = function e(t, n) {
                if (t === n) return !0;
                ...
                for (var r in t)
                    if (t.hasOwnProperty(r)) {
                        ...
                        if (t[r] !== n[r]) {
                            if ("object" != typeof t[r]) return !1;
                            if (!e(t[r], n[r])) return !1
                        }
                    } for (r in n)
                    if (n.hasOwnProperty(r) && !t.hasOwnProperty(r)) return !1;
                return !0
            }
        }, function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoInspectorEnv = t.AvoInspector = void 0;
            var r = n(0);
            Object.defineProperty(t, "AvoInspector", {
                enumerable: !0,
                get: function() {
                    return r.AvoInspector
                }
            });
            var o = n(2);
            Object.defineProperty(t, "AvoInspectorEnv", {
                enumerable: !0,
                get: function() {
                    return o.AvoInspectorEnv
                }
            })
        }, function(e, t, n) {
            "use strict";
            ...
            var r = n(0),
                o = function() {
                    function e(t) {
                        var n = this;
                        this.events = [], this.networkCallsHandler = t, this.batchFlushAttemptTimestamp = Date.now(), r.AvoInspector.avoStorage.getItemAsync(e.cacheKey).then(function(e) {
                            if (null !== e) {
                                var t = e.filter(function(e) {
                                    return null !== e
                                });
                                n.events = n.events.concat(t), n.checkIfBatchNeedsToBeSent()
                            }
                        })
                    }
                    return e.prototype.handleSessionStarted = function() {
                        this.events.push(this.networkCallsHandler.bodyForSessionStartedCall()), this.saveEvents(), this.checkIfBatchNeedsToBeSent()
                    }, e.prototype.handleTrackSchema = function(e, t, n, o) {
                        this.events.push(this.networkCallsHandler.bodyForEventSchemaCall(e, t, n, o)), this.saveEvents(), r.AvoInspector.shouldLog, this.checkIfBatchNeedsToBeSent()
                    }, e.prototype.checkIfBatchNeedsToBeSent = function() {
                        var e = this.events.length,
                            t = Date.now(),
                            n = t - this.batchFlushAttemptTimestamp,
                            o = e % r.AvoInspector.batchSize == 0,
                            i = n >= 1e3 * r.AvoInspector.batchFlushSeconds,
                            a = this;
                        if (o || i) {
                            this.batchFlushAttemptTimestamp = t;
                            var s = a.events;
                            a.events = [], this.networkCallsHandler.callInspectorWithBatchBody(s, function(e) {
                                null != e ? (a.events = a.events.concat(s), r.AvoInspector.shouldLog) : r.AvoInspector.shouldLog, a.saveEvents()
                            })
                        }
                    }, e.prototype.saveEvents = function() {
                        if (this.events.length > 1e3) {
                            var t = this.events.length - 1e3;
                            this.events.splice(0, t)
                        }
                        r.AvoInspector.avoStorage.setItem(e.cacheKey, this.events)
                    }, Object.defineProperty(e, "cacheKey", {
                        get: function() {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoNetworkCallsHandler = void 0;
            var r = n(1),
                o = n(4),
                i = n(0),
                a = n(9),
                s = function() {
                    function e(e, t, n, r, o) {
                        this.samplingRate = 1, this.sending = !1, this.apiKey = e, this.envName = t, this.appName = n, this.appVersion = r, this.libVersion = o
                    }
                    return e.prototype.callInspectorWithBatchBody = function(t, n) {
                        var r = this;
                        if (this.sending) n("Batch sending cancelled because another batch sending is in progress. Your events will be sent with next batch.");
                        else {
                            var o = t.filter(function(e) {
                                return null != e
                            });
                            if (this.fixSessionAndTrackingIds(o), 0 !== o.length)
                                if (Math.random() > this.samplingRate) i.AvoInspector.shouldLog;
                                else {
                                    i.AvoInspector.shouldLog && o.forEach(function(e) {
                                        if ("sessionStarted" === e.type);
                                        else if ("event" === e.type);
                                    }), this.sending = !0;
                                    var a = new XMLHttpRequest;
                                    a.open("POST", e.trackingEndpoint, !0), a.setRequestHeader("Content-Type", "text/plain"), a.send(JSON.stringify(o)), a.onload = function() {
                                        if (200 != a.status) n("Error " + a.status + ": " + a.statusText);
                                        else {
                                            var e = JSON.parse(a.response).samplingRate;
                                            void 0 !== e && (r.samplingRate = e), n(null)
                                        }
                                    }, a.onerror = function() {
                                        n("Request failed")
                    ...
                    }, e.prototype.fixSessionAndTrackingIds = function(e) {
                        var t = null,
                            n = null;
                        e.forEach(function(e) {
                            null !== e.sessionId && void 0 !== e.sessionId && "unknown" !== e.sessionId && (t = e.sessionId), null !== e.trackingId && void 0 !== e.trackingId && "unknown" !== e.trackingId && (n = e.trackingId)
                        }), e.forEach(function(e) {
                            "unknown" === e.sessionId && (e.sessionId = null != t ? t : o.AvoSessionTracker.sessionId), "unknown" === e.trackingId && (e.trackingId = null != n ? n : a.AvoInstallationId.getInstallationId())
                        })
                    }, e.prototype.bodyForSessionStartedCall = function() {
                        var e = this.createBaseCallBody();
                        return e.type = "sessionStarted", e
                    }, e.prototype.bodyForEventSchemaCall = function(e, t, n, r) {
                        var o = this.createBaseCallBody();
                        return o.type = "event", o.eventName = e, o.eventProperties = t, null != n ? (o.avoFunction = !0, o.eventId = n, o.eventHash = r) : (o.avoFunction = !1, o.eventId = null, o.eventHash = null), o
                    }, e.prototype.createBaseCallBody = function() {
                        return {
                            apiKey: this.apiKey,
                            ...
                            env: this.envName,
                            libPlatform: "web",
                            messageId: r.default.newGuid(),
                            trackingId: a.AvoInstallationId.getInstallationId(),
                            createdAt: (new Date).toISOString(),
                            sessionId: o.AvoSessionTracker.sessionId,
                            samplingRate: this.samplingRate
                        }
                    }, e.trackingEndpoint = "https://api.avo.app/inspector/v1/track", e
                }();
            t.AvoNetworkCallsHandler = s
        }, function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoInstallationId = void 0;
            var r = n(1),
                o = n(0),
                i = function() {
                    function e() {}
                    return e.getInstallationId = function() {
                        if (null !== e.installationId) return e.installationId;
                        if (!o.AvoInspector.avoStorage.isInitialized()) return "unknown";
                        var t = o.AvoInspector.avoStorage.getItem(e.cacheKey);
                        return null == t ? (e.installationId = r.default.newGuid(), o.AvoInspector.avoStorage.setItem(e.cacheKey, e.installationId)) : e.installationId = t, e.installationId
                    }, Object.defineProperty(e, "cacheKey", {
                        get: function() {
                        ...
                        enumerable: !1,
                        configurable: !0
                    }), e.installationId = null, e
                }();
            t.AvoInstallationId = i
        }, function(e, t, n) {
            "use strict";
            ...
            var i = function() {
                    function e() {}
                    return e.prototype.parseJson = function(e) {
                ...
                a = (function(e) {
                    function t() {
                        ...
                        return t.androidMemoryDataToAvoidAsyncQueries = {}, t.AsyncStorage = null, t.memoryStorageInitialized = !1, t.onStorageInitFuncs = [], t.reactNative = null, t.shouldLog = !1, t
                    }
                    o(t, e), t.prototype.init = function(e) {}, t.prototype.loadAndroidDataToMemoryToAvoidAsyncQueries = function(e) {
                        var t = this;
                        this.AsyncStorage.getAllKeys().then(function(n) {
                            return t.AsyncStorage.multiGet(n).then(function(n) {
                                t.shouldLog, n.forEach(function(e) {
                                    var n = e[0];
                                    t.androidMemoryDataToAvoidAsyncQueries[n] = e[1], t.shouldLog
                                }), e()
                            })
                        })
                    }, t.prototype.initializeStorageAndroid = function() {
                        this.memoryStorageInitialized = !0, this.onStorageInitFuncs.forEach(function(e) {
                            e()
                        })
                    }, t.prototype.isInitialized = function() {
                        return this.reactNative && this.memoryStorageInitialized
                    }, t.prototype.getItemAsync = function(e) {
                        return this.AsyncStorage.getItem(e).then(function(e) {
                            return null != e ? JSON.parse(e) : null
                        })
                    }, t.prototype.getItem = function(e) {
                        var t = this.androidMemoryDataToAvoidAsyncQueries[e];
                        return this.parseJson(t)
                    }, t.prototype.setItem = function(e, t) {
                        this.AsyncStorage.setItem(e, JSON.stringify(t)), this.androidMemoryDataToAvoidAsyncQueries[e] = JSON.stringify(t)
                    }, t.prototype.removeItem = function(e) {
                        this.AsyncStorage.removeItem(e), this.androidMemoryDataToAvoidAsyncQueries[e] = null
                    }, t.prototype.runAfterInit = function(e) {
                        !0 === this.memoryStorageInitialized ? e() : this.onStorageInitFuncs.push(e)
                    }
                }(i), function(e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.reactNative = null, t
                    }
                    o(t, e), t.prototype.init = function(e) {}, t.prototype.isInitialized = function() {
                        return null != this.reactNative
                    }, t.prototype.getItemAsync = function(e) {
                        var t = this.reactNative.Settings.get(e);
                        return Promise.resolve(this.parseJson(t))
                    }, t.prototype.getItem = function(e) {
                        var t = this.reactNative.Settings.get(e);
                        return this.parseJson(t)
                    }, t.prototype.setItem = function(e, t) {
                        var n;
                        this.reactNative.Settings.set(((n = {})[e] = JSON.stringify(t), n))
                    }, t.prototype.removeItem = function(e) {
                        var t;
                        this.reactNative.Settings.set(((t = {})[e] = null, t))
                    }, t.prototype.runAfterInit = function(e) {
                        e()
                    }
                }(i), function(e) {
                    function t() {
                        var t = null !== e && e.apply(this, arguments) || this;
                        return t.useFallbackStorage = !1, t.fallbackStorage = {}, t.storageInitialized = !1, t.onStorageInitFuncs = [], t.shouldLog = !1, t
                    }
                    return o(t, e), t.prototype.init = function(e) {
                        this.shouldLog = e, this.initializeStorageWeb(this.isLocalStorageAvailable())
                    }, t.prototype.initializeStorageWeb = function(e) {
                        this.storageInitialized = !0, !1 === e && (this.useFallbackStorage = !0), this.onStorageInitFuncs.forEach(function(e) {
                            e()
                        })
                    }, t.prototype.isLocalStorageAvailable = function() {
                        var e = (new Date).toISOString();
                        try {
                            return window.localStorage.setItem(e, e), window.localStorage.getItem(e) === e && (window.localStorage.removeItem(e), !0)
                        } catch (e) {
                            return !1
                        }
                    }, t.prototype.isInitialized = function() {
                        ...
                        var t = this;
                        return new Promise(function(n, r) {
                            t.runAfterInit(function() {
                                if (!0 === t.useFallbackStorage) {
                                    var r = t.fallbackStorage[e];
                                    n(t.parseJson(r))
                        ...
                        var t;
                        if (!1 === this.storageInitialized) t = null;
                        else if (!0 === this.useFallbackStorage) t = this.fallbackStorage[e];
                        else if ("undefined" != typeof window) try {
                        ...
                        this.runAfterInit(function() {
                            if (!0 === n.useFallbackStorage) n.fallbackStorage[e] = JSON.stringify(t);
                            else if ("undefined" != typeof window) try {
                        ...
                        var t = this;
                        this.runAfterInit(function() {
                            if (!0 === t.useFallbackStorage) t.fallbackStorage[e] = null;
                            else if ("undefined" != typeof window) try {
                        ...
                        !0 === this.storageInitialized ? e() : this.onStorageInitFuncs.push(e)
                    }, t
                }(i)),
                s = function() {
                    function e(e) {
                        this.Platform = null, this.Platform = "browser", this.storageImpl = new a, this.storageImpl.init(e)
                    }
                    return e.prototype.isInitialized = function() {
                        return this.storageImpl.isInitialized()
                    }, e.prototype.getItemAsync = function(e) {
                        return this.storageImpl.getItemAsync(e)
                    }, e.prototype.getItem = function(e) {
                        return this.storageImpl.getItem(e)
                    }, e.prototype.setItem = function(e, t) {
                        this.storageImpl.setItem(e, t)
                    }, e.prototype.removeItem = function(e) {
                        this.storageImpl.removeItem(e)
                    }, e.prototype.runAfterInit = function(e) {
                        this.storageImpl.runAfterInit(e)
                    }, e
                }();
            t.AvoStorage = s
        }, function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.AvoDeduplicator = void 0;
            var r = n(3),
                o = n(5),
                i = function() {
                    function e() {
                        this.avoFunctionsEvents = {}, this.manualEvents = {}, this.avoFunctionsEventsParams = {}, this.manualEventsParams = {}
                    }
                    return e.prototype.shouldRegisterEvent = function(e, t, n) {
                        this.clearOldEvents(), n ? (this.avoFunctionsEvents[Date.now()] = e, this.avoFunctionsEventsParams[e] = t) : (this.manualEvents[Date.now()] = e, this.manualEventsParams[e] = t);
                        var r = !n;
                        return !this.hasSameEventAs(e, t, r)
                    }, e.prototype.hasSameEventAs = function(e, t, n) {
                        var r = !1;
                        return n ? this.lookForEventIn(e, t, this.avoFunctionsEventsParams) && (r = !0) : this.lookForEventIn(e, t, this.manualEventsParams) && (r = !0), r && (delete this.avoFunctionsEventsParams[e], delete this.manualEventsParams[e]), r
                    }, e.prototype.lookForEventIn = function(e, t, n) {
                        for (var r in n)
                            if (n.hasOwnProperty(r) && r === e) {
                                var i = n[e];
                                if (i && o.deepEquals(t, i)) return !0
                            } return !1
                    }, e.prototype.hasSeenEventParams = function(e, t) {
                        var n = !1;
                        return t ? this.lookForEventParamsIn(e, this.avoFunctionsEventsParams) && (n = !0) : this.lookForEventParamsIn(e, this.manualEventsParams) && (n = !0), n
                    }, e.prototype.lookForEventParamsIn = function(e, t) {
                        for (var n in t)
                            if (t.hasOwnProperty(n)) {
                                var r = t[n];
                                if (r && o.deepEquals(e, r)) return !0
                            } return !1
                    }, e.prototype.shouldRegisterSchemaFromManually = function(e, t) {
                        return this.clearOldEvents(), !this.hasSameShapeInAvoFunctionsAs(e, t)
                    }, e.prototype.hasSameShapeInAvoFunctionsAs = function(e, t) {
                        var n = !1;
                        return this.lookForEventSchemaIn(e, t, this.avoFunctionsEventsParams) && (n = !0), n && delete this.avoFunctionsEventsParams[e], n
                    }, e.prototype.lookForEventSchemaIn = function(e, t, n) {
                        for (var i in n)
                            if (n.hasOwnProperty(i) && i === e) {
                                var a = r.AvoSchemaParser.extractSchema(n[e]);
                                if (a && o.deepEquals(t, a)) return !0
                            } return !1
                    }, e.prototype.clearOldEvents = function() {
                        var e = Date.now();
                        for (var t in this.avoFunctionsEvents)
                            if (this.avoFunctionsEvents.hasOwnProperty(t) && e - (Number(t) || 0) > 300) {
                                var n = this.avoFunctionsEvents[t];
                                delete this.avoFunctionsEvents[t], delete this.avoFunctionsEventsParams[n]
                            } for (var t in this.manualEvents) this.manualEvents.hasOwnProperty(t) && e - (Number(t) || 0) > 300 && (n = this.manualEvents[t], delete this.manualEvents[t], delete this.manualEventsParams[n])
    ...
    var a = function() {
        ...
        f = "NEXTGEN_PROFILE_CAT4_FEEDBACK3",
        p = t.InstantMobileVerificationView = function(e) {
            function t() {
                r(this, t);
                var e = o(this, (t.__proto__ || Object.getPrototypeOf(t)).apply(this, arguments));
                return e.verifySuccess = function(t) {
                    ...
                    n === c ? (e.displayErrorMsg(VOLO.instantVerificationTranslation.rate_limited), e.hideResendLink()) : n === l ? e.displayErrorMsg(VOLO.instantVerificationTranslation.invalid_number) : n === d || n === f ? e.displayErrorMsg(VOLO.instantVerificationTranslation.already_verified) : e.displayErrorMsg(VOLO.instantVerificationTranslation.general)
            ...
            y = function(t) {
                ...
                return a(n, t), s(n, [{
                    ...
                    value: function() {
                        ...
                        }, n.resendCodeIn), " ", h.default.createElement(g.default, {
    ...
    (function(e) {
        ...
        var n = t.compareArrays = function(t, n) {
            return e.isMatch(t, n) && e.isMatch(n, t)
        };
        t.isSimilarProductsWithoutQuantity = function(e, t) {
            var r = e.toppings.map(function(e) {
                    return "" + e.id
                }),
                o = t.toppings.map(function(e) {
                    return "" + e.id
                }),
                i = e.variation_id === t.variation_id,
                a = n(r.sort(), o.sort());
            return i && a
        }
    }).call(t, n(1))
    ...
    var o = function() {
        ...
        a = function() {
            ...
            return o(e, [{
                ...
                key: "formatCurrency",
                value: function(e) {
                    return this.hideDecimalInCurrency && "tr" === this.countryCode ? this.currencyFormatter.format(e).split("Â ").reverse().join("Â ").replace("TLY", "TL") : this.hideDecimalInCurrency ? this.currencyFormatter.format(Math.ceil(e)) : "tr" === this.countryCode ? this.currencyFormatter.format(e).split("Â ").reverse().join("Â ").replace("TLY", "TL") : this.currencyFormatter.format(e)
                }
            }, {
                key: "formatNumber",
                value: function(e) {
                ...
                value: function(e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                        r = new this.intl.DateTimeFormat(this.locale, t);
                    return n ? r.formatToParts(e) : r.format(e)
                }
            }]), e
        }();
    t.default = a
