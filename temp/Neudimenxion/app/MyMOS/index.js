 ...
 * under the License.
 */
let redirectedURL = 'https://mymos.my/members-account/',
    isFCMRegistered,
    FCMToken,
    FCMID,
    isCameraOpened, 
    ...
    addIABEventListener(){
        ...
        ref.addEventListener('loadstart', function(e){
            ...
            if(e.url.includes('login')){
                isLogin = true;alert('login')
            }else if(e.url.includes('pincode')){
                if(isLogin){
                    isLogin = false;alert('false')
                }else{
                   alert('cl'); navigator.app.exitApp();
                }
            }
        });
    },
        ...
        function onDone(err, status){
            ...
            if (status.authorized) {
                ...
                if(isFirstTime){
                    ...
                    setTimeout(()=>{this.openCamera();},1250);
                }else{
                    this.openCamera();
                }
