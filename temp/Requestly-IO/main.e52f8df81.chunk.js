(this.webpackJsonprequestly = this.webpackJsonprequestly || []).push([
	...
	[, , function(e, t, a) {
						...
						O = function() {
							...
							return l(t, null, [{
								...
								value: function(t, a) {
									var n = a,
										r = m(a),
										l = s(a, T.URL_COMPONENTS.HASH),
										c = s(a, T.URL_COMPONENTS.QUERY),
										o = i(c),
										E = t.param,
										d = t.value;
									switch (t.type) {
										...
										case T.MODIFICATION_TYPES.REMOVE:
											...
											break;
										case T.MODIFICATION_TYPES.REMOVE_ALL:
											n = r + l
									}
									return n
								}
															...
															if (E.target && E.header && null !== d.matchUrlWithRulePair(m, a, r) && (o = !0, !c || E.target === c)) {
																...
																switch (E.type) {
																	...
																	case f.MODIFICATION_TYPES.REMOVE:
																		...
																		break;
																	case f.MODIFICATION_TYPES.MODIFY:
																		d.modifyHeaderIfExists(i, {
																			name: E.header,
																			value: p
																		});
																		break;
																	case f.MODIFICATION_TYPES.REPLACE:
																		d.replaceHeader(i, {
																			name: E.header,
																			value: p
																		})
		...
		f.MODES.CREATE = "create", f.MODES.EDIT = "edit", f.MODES.SHARED_LIST_RULE_VIEW = "shared-list-rule-view";
		var T = f,
			O = function(e, t) {
		...
		var b = N,
			...
			C = {
				...
				Script: {
					...
					CUSTOM_SCRIPT_CHARACTER_LIMIT: 5500
				},
				Response: {
					ID: 7,
		...
		var F = G,
			...
			V = B,
			H = {};
		H.FEATURES = p, H.PRICING = w, H.MIGRATED_TO_NEW_UI = "migrated-to-new-ui", H.LAST_BACKUP_TIMESTAMP = "last-backup-timestamp", H.LINKS = A, H.STYLES = F, H.RULE_EDITOR_CONFIG = T, H.PATHS = b, H.RULE_TYPES_CONFIG = C, H.RULES_LIST_TABLE_CONSTANTS = I, H.SHARED_LISTS_TABLE_CONSTANTS = L, H.MARKETPLACE_TABLE_CONSTANTS = g, H.FILES_TABLE_CONSTANTS = _, H.THEME_COLORS = v, H.AUTH = P, H.LIMIT_REACHED_MODAL = j, H.NOTIFICATION_DURATION = 2e3, H.DELAY_COMPATIBILITY_VERSION = "21.6.04", H.BETA = "beta", H.LOCAL = "local", H.PROD = "prod", H.EMAIL_DOMAINS = M, H.COOKIES = V;
		var Y = H,
			...
			ee = (a(227), a(228), a(229), a(230), a(27)),
			te = a(16),
			ae = a.n(te),
			ne = a(81),
			re = a(506),
			...
			Se = a(508),
			Ae = a(509),
			fe = (a(231), a(233), a(497), a(498), a(499), ne.a),
			Te = function(e) {
			...
			He = function() {
				var e = Object(ee.g)(),
					...
					g = Object(l.useCallback)((function() {
						s(!0), fe.functions().httpsCallable("getTeamInvite")({
							inviteCode: Ve(a)
						}).then((function(e) {
					...
					h = function() {
						f(!0), fe.functions().httpsCallable("acceptTeamInvite")({
							inviteCode: Ve(a)
						}).then((function(a) {
							if (!t.current) return null;
							var n = a.data;
							f(!1), n.success ? (le.b.info("You have been added to the team"), Pe(e, !0)) : le.b.warn(n.message)
						})).catch((function(e) {
							if (!t.current) return null;
							le.b.warn(e.message)
						}))
				...
				return Object(l.useEffect)((function() {
					...
					className: " shadow"
				}, c.a.createElement(Ae.a, null, c.a.createElement(pe.a, null, o ? c.a.createElement(Te, {
			...
			dt = mt,
			pt = function(e) {
				return !!(e && e.loggedIn && e.details.planDetails) && ("referral" === e.details.planDetails.type ? St(e.details.planDetails.planId) && !Tt(e.details.planDetails) : "active" === e.details.planDetails.status && St(e.details.planDetails.planId) && !Tt(e.details.planDetails))
			},
			St = function(e) {
				if (!e) return !1;
				var t = e.split("_")[0];
			...
			Tt = function(e) {
				return !(!e || !e.subscription) && ft(e) < (new Date).toISOString().split("T")[0]
			},
			Ot = function(e) {
				...
				if (Tt(t)) return Y.PRICING.PLAN_NAMES.BRONZE;
				var a = t.planId;
		...
		function Ra(e) {
			var t = new fe.auth.GoogleAuthProvider;
			return t.addScope("profile"), t.addScope("email"), fe.auth().signInWithPopup(t).then((function(t) {
				Fa(ba.ACTIONS.GMAIL_LOGIN_PERFORMED), Ta(t.user.uid), fa(t.user.uid, !0);
				var a = La(t.user);
				return fe.database().ref(Ia(a.uid)).update(a), e && e.call(null, !0), a
			}))
		}
		var ha = function() {
				return new Promise(function() {
					var e = Object(ea.a)($t.a.mark((function e(t, a) {
						...
						return $t.a.wrap((function(e) {
							for (;;) switch (e.prev = e.next) {
								case 0:
									n = Object(na.a)(), (r = fe.database().ref("ot-auth-codes/".concat(n))).on("value", function() {
										var e = Object(ea.a)($t.a.mark((function e(a) {
											...
											return $t.a.wrap((function(e) {
												for (;;) switch (e.prev = e.next) {
													...
													case 3:
														return e.next = 5, fe.auth().signInWithCustomToken(n);
													case 5:
			...
			Ca = function() {
				var e = Object(ea.a)($t.a.mark((function e(t, a) {
					...
					return $t.a.wrap((function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								return e.prev = 0, e.next = 3, fe.auth().signInWithEmailLink(t, window.location.href);
							case 3:
								return n = e.sent, r = La(n.user), fe.database().ref(Ia(r.uid)).update(r), a && a.call(null, !0), e.abrupt("return", r);
							case 10:
			...
			if (e.attr && e.value) {
				...
				if (Da.isUserAuthenticated((function(e) {
						e && e.uid && function(e, t, a) {
							var n = e.uid,
								r = {};
							r[t] = a, fe.database().ref("/customProfile/".concat(n, "/attributes")).update(r)
						}(e, t, a)
		...
		var ka = S.CONSTANTS.GA_EVENTS,
			...
			Ya = function(e) {
				...
				return c.a.createElement(Xt.a, {
					...
					disabled: ae()(s) || d,
					onClick: function(e) {
						e && e.preventDefault(), p(!0), fe.functions().httpsCallable("createTeam")({
							teamName: s
						}).then((function(e) {
			...
			Ja = function() {
				var e = Object(l.useState)(!0),
					...
					E = Object(l.useCallback)((function() {
						n(!0), fe.functions().httpsCallable("getUserTeams")().then((function(e) {
				...
				return Object(l.useEffect)((function() {
					...
					teams: s
				}) : c.a.createElement(c.a.Fragment, null, a ? c.a.createElement(Te, {
			...
			sn = function(e) {
				var t = e.hideShadow,
					...
					y = _[1];
				return Object(l.useEffect)((function() {
					i.details && i.details.planDetails && i.details.planDetails.status ? (p(i.details.planDetails.status), T(i.details.planDetails.type), g(i.details.planDetails.subscription.startDate), I(i.details.planDetails.subscription.endDate)) : y(!0)
				}), [i]), i ? r && i && i.details && i.details.planDetails && "individual" === i.details.planDetails.type || o && v ? c.a.createElement(c.a.Fragment, null) : c.a.createElement(c.a.Fragment, null, d && f && b && C && !v ? c.a.createElement(on, {
					customHeading: a,
					hideShadow: t,
			...
			pn = function(e) {
				...
				return Object(l.useEffect)((function() {
					Da.getValue(["users", i.details.profile.uid]).then((function(e) {
						if (e) {
							var t = e.profile;
							t && (t.displayName && T(t.displayName), t.address && (t.address.line1 && g(t.address.line1), t.address.line2 && I(t.address.line2), t.address.city && y(t.address.city), t.address.state && w(t.address.state), t.address.postal_code && V(t.address.postal_code), t.address.country && M(t.address.country)))
						}
					}))
			...
			hn = function(e, t, a, n, r, l, c) {
				...
				return ae()(t) || !An()(t) ? (bn("Please enter a valid email"), null) : ae()(a) ? (bn("Opps! You forgot to enter password"), null) : (n && n(!0), void
					function(e, t) {
						return fe.auth().signInWithEmailAndPassword(e, t).then((function(e) {
			...
			Cn = function(e, t, a, n, r) {
				switch (e && e(!0), t) {
					...
					var t = new fe.auth.OAuthProvider("apple.com");
					return fe.auth().signInWithPopup(t).then((function(t) {
						Fa(ba.ACTIONS.APPLE_LOGIN_PERFORMED), Ta(t.user.uid), fa(t.user.uid, !0);
						var a = La(t.user);
						return fe.database().ref(Ia(a.uid)).update(a), e && e.call(null, !0), a
					}))
				})().then((function(l) {
			...
			In = function(e, t, a, n, r, l, c) {
				e.preventDefault(), l(!0),
					function(e, t, a, n) {
						...
						}) : fe.auth().createUserWithEmailAndPassword(t, a).then((function(a) {
							return a.user.sendEmailVerification({
								url: window.location.href,
								handleCodeInApp: !0
							}).then((function() {
								Ta(a.user.uid), fa(a.user.uid, !1)
							})), a.user.updateProfile({
								displayName: e,
								photoURL: "https://www.gravatar.com/avatar/".concat(aa()(t))
							}).then((function() {
								var e = La(a.user);
								return fe.database().ref(Ia(e.uid)).update(e).then((function() {
									(ga.log("Profile Created Successfully"), Ba(e.email), n) && fe.functions().httpsCallable("applyRefCode")({
										code: n,
										uid: e.uid,
										email: e.email
									}).then((function(e) {
			...
			Ln = function(e, t, a, n) {
				...
				a(!0),
					function(e) {
						return fe.auth().sendPasswordResetEmail(e).then((function(e) {
			...
			_n = function(e, t, a, n, r) {
				...
				(function(e, t) {
					return t ? fe.auth().confirmPasswordReset(e, t).then((function(e) {
			...
			vn = function(e, t, a, n, r) {
				...
				(l = c, l ? fe.auth().verifyPasswordResetCode(l).then((function(e) {
					return Promise.resolve({
						status: !0,
						email: e
					})
			...
			yn = function() {
				var e = Object(ea.a)($t.a.mark((function e() {
					return $t.a.wrap((function(e) {
						for (;;) switch (e.prev = e.next) {
							case 0:
								return e.prev = 0, e.abrupt("return", fe.auth().signOut());
							case 4:
		...
		var Yn = function(e) {
			...
			Kn = function(e) {
				...
				return c.a.createElement(Se.a, {
					...
					if (f) return c.a.createElement(de.a, {
						className: "my-4",
						color: "primary",
						type: "button"
					}, c.a.createElement(R.S, {
					...
					switch (a) {
						...
						case Wn.LOG_IN:
							return c.a.createElement(de.a, {
								...
								type: "submit",
								onClick: function(e) {
									return hn(e, I, y, T, n, i, (function() {
										return P("")
									}))
								}
							}, "Sign in");
			...
			Jn = function() {
						...
						var e = Object(ea.a)($t.a.mark((function e(t) {
							...
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									...
									case 3:
										r = e.sent, l = a.get("ot-auth-code"), fe.functions().httpsCallable("createAuthToken")({
											oneTimeCode: l,
											idToken: r
										}).then((function(e) {
											n(!0), window.close()
				...
				return Object(l.useEffect)((function() {
					fe.auth().getRedirectResult().then(function() {
						var e = Object(ea.a)($t.a.mark((function e(t) {
							var a;
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									...
									case 3:
										...
										break;
									case 5:
										if (!fe.auth().currentUser) {
											e.next = 10;
											break
										}
										return e.next = 8, m(fe.auth().currentUser);
									case 8:
										e.next = 12;
										break;
									case 10:
										a = new fe.auth.GoogleAuthProvider, fe.auth().signInWithRedirect(a);
									case 12:
									case "end":
										return e.stop()
								}
			...
			ar = function(e) {
				var t = e.mode,
					...
					H = Object(l.useCallback)((function() {
						_(!0), fe.functions().httpsCallable("getTeamInfo")({
							teamId: a
						}).then((function(e) {
							if (!p.current) return null;
							var t = e.data;
					...
					W = Object(l.useCallback)((function() {
						(_(!0), A && A.details && A.details.profile.email) && (U(A.details.profile.email), _(!1), fe.functions().httpsCallable("fetchIndividualUserSubscriptionDetails")({}).then((function(e) {
							if (!p.current) return null;
							var t = e.data.data;
				...
				}, "(Flexible)")))) : L ? c.a.createElement(Te, null) : c.a.createElement(c.a.Fragment, null, c.a.createElement(pe.a, null, c.a.createElement(me.a, {
					className: "font-weight-bold"
			...
			ir = function() {
						...
						var r = Object(ea.a)($t.a.mark((function r(l) {
							...
							return $t.a.wrap((function(r) {
								for (;;) switch (r.prev = r.next) {
									...
									case 20:
										c ? Y(!1) : (S = ln(i, g), "team" === o ? A = fe.functions().httpsCallable("createTeamSubscription") : "individual" === o && (A = fe.functions().httpsCallable("createIndividualSubscription")), A({
											rqPlanId: S,
											teamId: s || null,
											currency: T,
											paymentMethodId: u
				...
				return Object(l.useEffect)((function() {
				...
				}), [$, m, o, z, i, X, s]), c.a.createElement(pe.a, null, c.a.createElement(me.a, null, c.a.createElement(Te, {
					...
					hideBillingAddress: !0,
					hideIndiaInCountryList: !T || "INR" !== T
				}), c.a.createElement("div", {
			...
			Er = function(e) {
				...
				return c.a.createElement(c.a.Fragment, null, e.renderHeader ? c.a.createElement(ue, null) : null, c.a.createElement(re.a, {
					...
					className: " has-no-box-shadow"
				}, c.a.createElement(Ae.a, null, c.a.createElement(pe.a, null, c.a.createElement(Te, {
			...
			pr = function(e) {
				...
				var r = Object(l.useState)(t),
					...
					T = A[1];
				return Object(l.useEffect)((function() {
					s === t && T(setInterval((function() {
						return i((function(e) {
							return e - 1
						}))
					}), 1e3)), s <= 0 && !d && (f && clearInterval(f), p(!0))
				}), [s, d, t, f]), d ? c.a.createElement(ee.a, {
					push: !0,
					to: a
				}) : c.a.createElement("h5", {
		...
		function br(e) {
			return fe.database().ref("/users/" + fe.auth().currentUser.uid + "/files/" + e).remove()
		}
		...
		function Rr(e, t) {
			return function(e, t) {
				...
				return fe.storage().ref("/users/" + fe.auth().currentUser.uid + "/files/").child(Date.now().toString()).child(t.name).put(e).then((function(e) {
					return e.ref.getDownloadURL().then((function(a) {
						return (n = a, new Promise((function(e, t) {
							...
							t.shortUrl = n;
							var r = gr(e, t, a),
								l = fe.database().ref("/users/" + fe.auth().currentUser.uid + "/files/").push(),
								c = l.key;
		...
		function hr(e, t, a) {
			...
			return fe.storage().ref(e).put(n, r).then((function(e) {
				return e.ref.getDownloadURL().then((function(t) {
					var n, r = gr(e, a, t);
					return r.id = a.id, (n = r, fe.database().ref(S.CONSTANTS.FIREBASE_NODES.USERS).child(fe.auth().currentUser.uid).child(S.CONSTANTS.FIREBASE_NODES.FILES).child(n.id).update(n)).then((function() {
						return {
							success: !0,
							data: r
						}
		...
		var Cr = Y.FILES_TABLE_CONSTANTS.COLUMN_WIDTHS,
			...
			Lr = function(e) {
				var t = e.fileDetails,
					...
					O = function(e, t) {
						var a;
						d(!0), (a = e, fe.storage().ref().child(a.filePath).delete().then((function() {
							return br(a.id)
						}), (function(e) {
				...
				return c.a.createElement(Tr.a, null, (function(e) {
					var l = e.isHovering;
					return c.a.createElement(c.a.Fragment, null, c.a.createElement("td", {
						...
						return c.a.createElement("td", {
							...
							className: "custom-tooltiptext"
						}, f === t.shortUrl ? "Copied" : "Copy direct link"))), c.a.createElement("span", {
							className: "custom-tooltip cursor-pointer",
							onClick: function() {
								return O(t, n)
							}
			...
			Dr = function(e) {
				...
				}, d === Y.LIMIT_REACHED_MODAL.MODES.CHECK_LIMIT ? r === Y.FEATURES.ACTIVE_RULES ? "Upgrade now to activate more rules" : "Upgrade now to create more ".concat(f) : "Upgrade now to enable ".concat(f)), c.a.createElement("p", null, d === Y.LIMIT_REACHED_MODAL.MODES.CHECK_LIMIT ? c.a.createElement("span", null, "It seems like you have reached your ", f, " limit.", " ", c.a.createElement("strong", null, A ? m : "Free", " "), " ", "accounts are limited to ", s, " ", f, ".", " ") : c.a.createElement("span", null, c.a.createElement("span", {
					style: {
						textTransform: "capitalize"
					}
				}, f), " ", "is a premium feature."), " ", "Upgrade to one of our premium plans to make sure you can access all of the Requestly features whenever you need it.")), function() {
			...
			zr = (a(297), a(298), a(299), a(300), a(301), a(85));
		...
		var Jr = function(e) {
			...
			el = function() {
				...
				return Object(l.useLayoutEffect)((function() {
					...
					className: "mb-0"
				}, I ? "Create" : "Edit", " File")))), o ? c.a.createElement(Te, null) : I ? c.a.createElement(Jr, {
					newFile: !0,
					fileDetails: T,
					data: g,
					...
					saveFile: function(t, a, n, r) {
						if (ae()(r)) le.b.warn("Please enter file content");
							...
							p(!0);
							var l = Object(E.a)({}, T);
							l.description = n, hr(T.filePath, r, l).then((function(t) {
			...
			sl = function() {
				var e = Object(l.useContext)(X).state,
					...
					v = L[1],
					y = function() {
						return t.loggedIn || "" === _ || /^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$/.test(_.trim()) ? 0 === ol && 0 === m.length ? le.b.error("Please select atleast one option") : 1 === ol && "" === S ? le.b.error("Please enter your feedback") : (C(!0), void fe.functions().httpsCallable("sendFeedbackResponse")({
			...
			El = function() {
				...
				if (Object(l.useLayoutEffect)((function() {
						Q()
					}), [Q, t]), j) return c.a.createElement(Te, {
				...
				return c.a.createElement(mn.a, {
					onSubmit: function(e) {
						e.preventDefault(), N(!0), fe.functions().httpsCallable("applyLicense")({
							license: r,
							company: S,
							email: F
						}).then((function(e) {
			...
			fl = function() {
				var e = Object(l.useContext)(X).state,
					...
					b = Object(l.useCallback)((function() {
						(o(!0), t.loggedIn) ? fe.functions().httpsCallable("getCompanyLicenseUsers")({}).then((function(e) {
				...
				return Object(l.useLayoutEffect)((function() {
					...
					return c.a.createElement("tr", {
						...
						onClick: function(t) {
							return function(e) {
								var t = O[e].email,
									a = fe.functions().httpsCallable("revokeLicense");
								A(!0), a({
									userId: e
								}).then((function(e) {
		...
		var ql = Y.RULE_TYPES_CONFIG,
			...
			Zl = function(e) {
				...
				return Object(l.useEffect)((function() {
					...
					onClick: function() {
						Ul() ? s.loggedIn ? O(!T) : o(Ut("authModal", !0, {
							redirectURL: window.location.href
						})) : R(!0)
					}
				}), c.a.createElement("span", {
					...
					m = function() {
						var e = Object(ea.a)($t.a.mark((function e() {
							...
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return t = fe.firestore().collection("marketplace"), e.next = 3, t.get();
									case 3:
			...
			fc = function(e) {
				var t = e.customHeading,
					...
					L = Object(l.useCallback)((function() {
						fe.functions().httpsCallable("fetchIndividualUserSubscriptionDetails")().then((function(e) {
							if (!n.current) return null;
							if (!1 === e.data.success) return p(!0), void i(!1);
							var t = e.data.data;
							I(t.status), "canceled" === t.status && p(!0), T(new Date(1e3 * t.endDate).toDateString()), g(new Date(1e3 * t.startDate).toDateString()), i(!1)
						})).catch((function(e) {
							if (!n.current) return null;
							i(!1)
						}))
				...
				}), [L]), c.a.createElement(c.a.Fragment, null, s ? c.a.createElement(pe.a, null, c.a.createElement(Te, null)) : d ? c.a.createElement(Xa, {
					customHeading: t,
					hideShadow: a
			...
			Tc = function(e) {
					...
					_ = function(e) {
						if (t) {
							...
							var n = [],
								...
								c = fe.firestore().collection(r).doc(l).collection("invoices").orderBy("created", "desc");
							e && (c = c.startAfter(e)), (c = c.limit(10)).get().then((function(e) {
								if (!o.current) return null;
								e.empty ? T(!0) : (e.forEach((function(e) {
				...
				}), [b, v, r]), c.a.createElement(c.a.Fragment, null, I ? c.a.createElement(Te, {
				...
				}, f ? c.a.createElement("span", null, "- End of all invoices -") : c.a.createElement(de.a, {
					onClick: function(e) {
			...
			Oc = function() {
				var e = Object(l.useRef)(!0),
					...
					o = Object(l.useCallback)((function() {
						fe.functions().httpsCallable("fetchIndividualUserSubscriptionDetails")().then((function(t) {
		...
		var Ic = ut,
			...
			_c = function(e) {
				...
				return c.a.createElement(c.a.Fragment, null, c.a.createElement("section", {
					...
					}, "Get Started") : f ? c.a.createElement("a", {
						href: Y.LINKS.CONTACT_US,
						className: ["btn", "btn-block", "text-uppercase", T && !f ? "btn-secondary cursor-disabled" : "btn-primary cursor-pointer"].join(" "),
						disabled: T && !f
					}, f ? "Contact Us" : T ? "Current plan" : "Contact Us") : c.a.createElement("button", {
						className: ["btn", "btn-block", "text-uppercase", T && !f ? "btn-secondary cursor-disabled" : "btn-primary cursor-pointer"].join(" "),
						disabled: T && !f
					}, f ? A() : T ? "Current plan" : A()))))
				}))))))
			},
			vc = function() {
		...
		function Pc(e) {
			var t = e.user,
				...
				m = i[0],
				E = i[1],
				d = fe.functions().httpsCallable("getEnterpriseAdminDetails"),
				p = fe.functions().httpsCallable("requestEnterprisePlanFromAdmin");
			return Object(l.useLayoutEffect)((function() {
		...
		var Uc = {
				getCancelSubmittedDetails: function() {
					var e = fe.auth().currentUser;
					e && fe.database().ref("userSubscriptions/".concat(e.uid, "/cancelSubmitted")).on("value", (function(e) {}))
				},
				getPlanDetails: function() {
					var e = fe.auth().currentUser;
					e && fe.database().ref("userSubscriptions/".concat(e.uid, "/planDetails")).on("value", (function(e) {
						return console.log(e.val()), e.val()
					}))
				},
				getPlans: function() {
					fe.database().ref("plans").on("value", (function(e) {
						console.log(e.val())
					}))
				},
				getFeatures: function() {
					fe.database().ref("features").on("value", (function(e) {}))
				},
				processPayment: function(e, t) {
					var a = fe.auth().currentUser.uid;
					return fe.database().ref("/userSubscriptions/".concat(a, "/planDetails")).update({
						token: e.id,
						planId: t,
						pending: !0
					})
				...
				cancelSubscription: function() {
					var e = fe.auth().currentUser.uid;
					return fe.database().ref("/userSubscriptions/".concat(e, "/cancelSubmitted")).update({
						pending: !0
					})
				},
				processPaypalPayment: function(e, t, a, n, r, l) {
					var c = fe.auth().currentUser.uid;
					return fe.database().ref("/userSubscriptions/".concat(c, "/planDetails")).update({
						orderId: e,
						planId: t,
						pending: !0,
						planDays: a,
			...
			jc = function(e) {
				var t = e.currency,
					...
					Se = de[0],
					Ae = de[1],
					fe = Object(l.useCallback)((function() {
					...
					Te = function(e, t) {
						ne(!1), t.order.capture().then((function(e) {
							Uc.processPaypalPayment(e.id, f[L].planId, Number(f[L].days), g, J, U).then((function() {
								le.b.info("You're Premium now."), window.location.reload(), Ma(Dc.CATEGORIES.PRICING, Dc.ACTIONS.BOUGHT, "Bought ".concat(f.name, " ").concat(L), J);
								var e = new Date;
								e.setDate((new Date).getDate() + Number(f[L].days)), Ga(Dc.ATTR.PLANNAME, f.name), Ga(Dc.ATTR.PLAN_DURATION, L), Ga(Dc.ATTR.PLAN_START_DATE, (new Date).toISOString().split("T")[0]), Ga(Dc.ATTR.PLAN_END_DATE, e.toISOString().split("T")[0]), U && (Ga(Dc.ATTR.COUPON, U), Ga(Dc.ATTR.COUPON_VALUE, y)), ie(!0)
							}))
						}))
					},
					Oe = function() {
				...
				return Object(l.useLayoutEffect)((function() {
					if (o.details.isLoggedIn && (o.details.planDetails ? (q(Tt(o.details.planDetails)), V(o.details.planDetails.planId.split("_")[0])) : V("bronze")), k || fe(), f && L && g && k) {
						var e = f[L].price[g];
						"gold" === f.id && "annual" === L ? e -= 0 * e : f.allowDiscounts && (e -= y / 100 * e), e = e.toFixed(2), Z(e)
					}
				}), [f, L, g, y, k, fe, o]), c.a.createElement(c.a.Fragment, null, c.a.createElement(pe.a, null, c.a.createElement(me.a, {
					lg: "12",
					md: "12",
					className: "text-center"
				}, c.a.createElement("h2", {
				...
				}, B === Y.PRICING.PLAN_NAMES.SILVER ? c.a.createElement(c.a.Fragment, null, c.a.createElement("span", null, "You are on Silver Plan which expires on", " ", ft(o.details.planDetails), ". Silver Plan is deprecated and can no longer be renewed. Please contact us at", " ", c.a.createElement("a", {
				...
				}), c.a.createElement("hr", null), f && L && g && k ? Re() : null))), Se ? c.a.createElement(vc, {
					isOpen: Se,
		...
		var kc = {
			...
			Fc = function() {
				var e = Object(l.useState)(""),
					...
					f = Object(l.useCallback)(Object(ea.a)($t.a.mark((function e() {
						var t;
						return $t.a.wrap((function(e) {
							for (;;) switch (e.prev = e.next) {
								case 0:
				...
				return c.a.createElement(pe.a, {
					className: "justify-content-center"
				}, p ? c.a.createElement(Te, null) : [Object(Rt.a)(Array(i)).map((function(e, t) {
					return c.a.createElement(me.a, {
						key: t,
		...
		var Zc = function() {
			...
			mo = function(e) {
				return io(e).then((function(t) {
					...
					return !t || r > 6 ? function(e) {
						...
						return fe.functions().httpsCallable("updateRulesBackup")({
							records: t,
							timestamp: n
						}).then((function() {
					...
					var t = Object(ea.a)($t.a.mark((function t(a) {
						...
						return $t.a.wrap((function(t) {
							for (;;) switch (t.prev = t.next) {
								case 0:
									return n = fe.firestore().collection("backup").doc(e), t.next = 3, n.get();
								case 3:
			...
			To = function() {
				...
				return Object(l.useEffect)((function() {
					...
					disabled: n,
					onClick: function() {
						r(!0), fe.functions().httpsCallable("refreshSubscription")().then((function(t) {
							if (!e.current) return null;
							var a = t.data;
			...
			go = function() {
				var e = Object(l.useContext)(X).state,
					...
					L = Object(l.useCallback)((function() {
						if (t.loggedIn) {
							...
							var e = Ot(t),
								a = Tt(t.details.planDetails);
							T(a ? Y.PRICING.PLAN_NAMES.BRONZE : e)
						} else s(!1)
					}), [t.loggedIn]),
					_ = function() {
						return c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
				...
				return Object(l.useEffect)((function() {
					...
					color: "info"
				}, "BETA"))))), c.a.createElement(Ae.a, null, f !== Y.PRICING.PLAN_NAMES.GOLD ? c.a.createElement(Ee.a, {
					style: {
						background: "transparent"
					},
					className: "text-center"
				...
				return Object(l.useLayoutEffect)((function() {
					...
					onClick: function() {
						...
						Ma(Io.CATEGORIES.REQUEST_UPGRADE, Io.ACTIONS.CLICKED, "RequestUpgrade email sent"), R || Pa(["customProfile", r.uid, "requestUpgrade"], {
							...
							fe.functions().httpsCallable("requestUpgrade")({
								userId: r.uid,
								emailContent: {
									managerEmail: m,
									subject: S,
			...
			qo = function(e) {
						...
						var e = Object(l.useCallback)((function(e) {
								...
								n.onabort = function() {
									...
									Ko(e, m, s).then((function(e) {
										f(e.data), C(e.rulesCount), v(e.groupsCount), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULES, S.CONSTANTS.GA_EVENTS.ACTIONS.IMPORTED, "Rules Imported", e.rulesCount)
									}))
								}, n.readAsText(a)
							}), []),
							a = Object(ko.a)({
				...
				return c.a.createElement(Xt.a, {
					...
					className: "display-2"
				}, c.a.createElement(Go.b, null)), c.a.createElement("h5", null, "Successfully parsed", " ", h > 0 ? h + " rules" : null, " ", _ > 0 ? "and " + _ + " groups" : null)) : U() : N ? c.a.createElement(Te, {
					...
					b = function(e) {
						e.stopPropagation(),
							function(e, t, a) {
								...
								Zo(u, f), le.b.info("Group deleted successfully"), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.GROUP, S.CONSTANTS.GA_EVENTS.ACTIONS.DELETED, "Group Deleted")
							})).catch((function(e) {
								return le.b.warn(e, {
									hideProgressBar: !0
								})
			...
			rs = function(e) {
				var t = e.groupId,
					...
					C = Ze(p),
					I = function(e) {
						e.stopPropagation(), ns(S, t, !T), O(!T)
					},
			...
			ss = function(e) {
				...
				return T && n !== cs ? c.a.createElement("td", {
					style: {
						width: Jo(o, 1, r) + "%"
					},
			...
			Ss = function(e) {
				var t = e.rule,
					...
					y = _[1],
					P = function(e) {
						Kl(f).saveRuleOrGroup(Object(E.a)(Object(E.a)({}, t), {}, {
							isFavourite: e
						})).then((function() {
			...
			Os = function(e) {
				...
				}, c.a.createElement(Ts.a, {
					className: "align-items-center"
				}, c.a.createElement(Ts.a, null, c.a.createElement("span", {
			...
			hs = function(e) {
				var t = e.toggle,
					...
					ee = function() {
						"" === I ? le.b.warning("Provide a shared list name") : T(!0)
					},
					te = function(e) {
					...
					ae = function() {
						Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.SHARED_LIST, S.CONSTANTS.GA_EVENTS.ACTIONS.CLICKED, "Notify Button Clicked"), q(!0), fe.functions().httpsCallable("sendShareListUrlAsEmailToShare")({
							sharedListData: V,
							recipientEmails: M
						}).then(function() {
							var e = Object(ea.a)($t.a.mark((function e(a) {
								...
								return $t.a.wrap((function(e) {
									for (;;) switch (e.prev = e.next) {
										case 0:
											(n = a.data).success ? (console.log(n), le.b.success("We've notified them"), Z([].concat(Object(Rt.a)(J), Object(Rt.a)(n.emails))), t()) : (q(!1), le.b.error("Opps! Check the email and try again")), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.SHARED_LIST, S.CONSTANTS.GA_EVENTS.ACTIONS.SHARED, "Notification Sent To people");
										case 3:
										case "end":
											return e.stop()
									}
					...
					ne = function() {
						return c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
							...
							className: "display-2"
						}, c.a.createElement(Mo.a, null)), c.a.createElement("h5", null, "Please select a rule before sharing"))), te({
							showConfirmationBtn: !1,
							showNotifyBtn: !1
						}))
					},
					re = Object(l.useCallback)((function(e, t, a) {
					...
					oe = function() {
						var e = Object(ea.a)($t.a.mark((function e(t) {
							...
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return a = fe.firestore().doc("sharedListEmails/".concat(t)), e.next = 3, a.get();
									case 3:
									...
									case 8:
										r = e.sent.data(), l = r.emails, c = l.map((function(e) {
											return {
												value: e,
												label: e
											}
					...
					(function() {
						var e = Object(ea.a)($t.a.mark((function e() {
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return e.next = 2, oe(E.details.profile.uid);
									case 2:
									case "end":
										return e.stop()
								}
				...
				}), [E.details.profile.uid]);
				var se = function(e) {
					13 === e.keyCode && ee()
				};
				return Object(l.useEffect)((function() {
					f && !b && Rs(d, n, I, m, E.details.profile.uid).then((function(e) {
						var t = e.sharedListId,
							a = e.sharedListName,
							n = e.sharedListData;
						re(t, a, n)
					})), Ga("iscreatesharedlisttask", !0)
				}), [f, b, n, I, m, E.details.profile.uid, re, d]), Object(l.useEffect)((function() {
					return document.addEventListener("keydown", se), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.SHARED_LIST, S.CONSTANTS.GA_EVENTS.ACTIONS.WORKFLOW_STARTED, "SharedList creation workflow started"),
						function() {
							document.removeEventListener("keydown", se)
						}
				}), [se]), c.a.createElement(Xt.a, {
					className: "modal-dialog-centered ",
					isOpen: a,
					toggle: t
				}, c.a.createElement("div", {
					...
					"aria-hidden": !0
				}, "\xd7"))), f ? b ? c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
					className: "modal-body "
				}, c.a.createElement(me.a, {
					lg: "12",
					md: "12",
					...
					className: "input-group-alternative has-traditional-border align-items-center flex-nowrap"
				}, c.a.createElement(gs.a, {
					isMulti: !0,
					options: J,
					onChange: function(e) {
					...
					trigger: "hover focus",
					target: "copy-icon"
				}, w === y ? "Copied" : "Copy To Clipboard"))))))), te({
					showConfirmationBtn: !1,
					showNotifyBtn: !0,
				...
				}) : 0 === n.length ? ne() : c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
					className: "modal-body "
				}, c.a.createElement(me.a, {
					lg: "12",
					md: "12",
			...
			vs = function(e) {
				var t = e.isHovering,
					...
					h = g[0],
					C = g[1],
					I = Object(l.useState)(Y.FEATURES.RULES),
					L = Object(u.a)(I, 2),
					_ = L[0],
					v = L[1],
					y = Object(l.useState)(0),
					...
					W = function() {
						var e = Object(ea.a)($t.a.mark((function e(t) {
							...
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return t.stopPropagation(), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE, a.ruleType + " rule", S.CONSTANTS.GA_EVENTS.ACTIONS.COPIED), e.next = 4, Kl().getAllRecords();
									case 4:
										if (n = e.sent, r = (new Date).getTime(), l = window.localStorage.getItem("authModalShownLastOn") || n.user_info.installationDate, c = (r - l) / 864e5, !(N.length >= 5 || c >= 15)) {
											e.next = 11;
											break
										}
										return window.localStorage.setItem("authModalShownLastOn", r), e.abrupt("return", V());
									case 11:
										o = Ot(T), i = bt(Y.FEATURES.RULES, o), N.filter((function(e) {
											return !oo(e)
										})).length >= i ? (D(i), C(o), v(Y.FEATURES.RULES), B(!0)) : Ls(O, 0, a, s);
									case 15:
									case "end":
										return e.stop()
								}
					...
					K = function(e) {
						e.stopPropagation(), T.loggedIn ? q() : V()
					},
					q = function() {
						var e = Ot(T);
						Nt(Y.FEATURES.EXPORT_IMPORT, e) ? (Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE, a.ruleType + " rule", S.CONSTANTS.GA_EVENTS.ACTIONS.EXPORTED), function(e, t) {
							var a = [];
							a.push(e), e.groupId !== Is.UNGROUPED_GROUP_ID && a.push(t[e.groupId][Is.GROUP_DETAILS]), Cs(JSON.stringify(a, null, 2), "requestly_rules.txt", "text/plain")
						}(a, f)) : (D(0), C(e), v(Y.FEATURES.EXPORT_IMPORT), B(!0))
					},
					Q = function(e) {
						e.stopPropagation(), T.loggedIn ? z() : V()
					},
					z = function() {
						p(Ut("loadingModal", !0));
						var e = Ot(T),
							t = bt(Y.FEATURES.SHARED_LISTS, e);
						_s(T.details.profile.uid).then((function(a) {
							var n = 0;
							a && (n = Object.keys(a).length), n >= t ? (D(t), C(e), v(Y.FEATURES.SHARED_LISTS), B(!0)) : (k(!0), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE, "rules", S.CONSTANTS.GA_EVENTS.ACTIONS.SHARED)), p(Ut("loadingModal", !1))
						}))
					},
					J = function(e) {
				...
				return !m && o ? c.a.createElement("td", {
					...
					className: "cursor-pointer"
				}, "Delete")))))) : null), j ? c.a.createElement(hs, {
					isOpen: j,
					toggle: function() {
						k(!j)
					},
					rulesToShare: [a.id]
				}) : null, F ? c.a.createElement(Dr, {
					isOpen: F,
					toggle: function() {
						B(!F)
					},
					...
					featureLimit: U,
					userPlanName: h,
					mode: 0 === U ? Y.LIMIT_REACHED_MODAL.MODES.CHECK_IF_ENABLED : Y.LIMIT_REACHED_MODAL.MODES.CHECK_LIMIT
				}) : null)
			},
			ys = Y.RULES_LIST_TABLE_CONSTANTS,
			Ps = ys.GROUP_RULES,
			Us = ys.UNGROUPED_GROUP_NAME,
			Ds = ys.COLUMN_WIDTHS,
			ws = [ps, Ss, fs, Os, Ns, bs, vs],
			xs = function(e) {
				var t = e.groupId,
					a = e.groupData,
					n = e.toggleGroupCollapse,
				...
				return c.a.createElement(c.a.Fragment, null, 0 !== a[Ps].length && o(t) === Us || 0 === E.length && o(t) !== Us ? d() : null, r(t) ? null : a[Ps].map((function(e) {
					return function(e) {
						return c.a.createElement(Tr.a, {
							key: e.id
						}, (function(t) {
							var a = t.isHovering;
							return c.a.createElement(c.a.Fragment, null, ws.map((function(t, n) {
			...
			Hs = function(e, t) {
				if (t) return {
					MODE: Ms.MODES.SHARED_LIST_RULE_VIEW
				};
				if (!e) return {};
			...
			Ws = function(e, t) {
				...
				return ae()(e.name) ? {
					...
					} : ua(e.response.value) > Ys(t) && (a = {
						result: !1,
						message: "Response should be less than ".concat(Ys(t), " characters.")
					})
			...
			Js = function(e) {
				...
				return c.a.createElement(c.a.Fragment, null, t === Y.RULE_EDITOR_CONFIG.MODES.EDIT ? c.a.createElement(de.a, {
					...
					onClick: function() {
						...
						var e = Ot(s),
							t = bt(Y.FEATURES.SHARED_LISTS, e);
						_s(s.details.profile.uid).then((function(a) {
							(function(e) {
								return e ? Object.keys(e).length : 0
							})(a) >= t ? (h(t), p(e), O(Y.FEATURES.SHARED_LISTS), j(!0)) : (_(zs(i)), U(!0), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE, "rules", S.CONSTANTS.GA_EVENTS.ACTIONS.SHARED)), n(Ut("loadingModal", !1))
						}))
					}
				}, c.a.createElement("span", {
					className: "btn-inner--icon"
			...
			ti = function(e, t, a, n) {
				...
				if ("string" === typeof a) t(ei(r, ["pairs[".concat(n, "].").concat(a)]));
				else {
			...
			ai = a(69),
			ni = function(e, t, a) {
				return ai(e.pairs[t], a, "")
			},
			ri = a(91),
			li = a(69),
			ci = function(e, t, a, n, r) {
				if (null === n || 0 === n.length) ti(e, t, r, a);
				else {
					var l = JSON.parse(JSON.stringify(e)),
						c = n.map((function(e) {
							return e.value
						}));
					ri(l.pairs[a], r, c), t(l)
				}
			},
			oi = function(e, t, a, n) {
				var r = li(e.pairs[t], a, []);
			...
			mi = function(e) {
				var t = e.modifyPairAtGivenPath,
					...
					u = function() {
						switch (ni(s, a, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_PAGE_URL_OPERATOR)) {
							case S.CONSTANTS.RULE_OPERATORS.WILDCARD_MATCHES:
								return "Wildcard";
							case S.CONSTANTS.RULE_OPERATORS.MATCHES:
								return "RegEx";
							case "":
								return "Select";
							default:
								return ni(s, a, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_PAGE_URL_OPERATOR)
						}
					},
					m = function(e) {
						return c.a.createElement("span", {
							...
							onClick: function() {
								ti(s, i, "source.filters.".concat(e), a), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE, S.CONSTANTS.GA_EVENTS.ACTIONS.DELETE, "Rule source " + e + " filter modified")
							}
						}, c.a.createElement($s.a, null), c.a.createElement("span", {
							className: "custom-tooltiptext"
						}, "Clear Filter"))
					},
					E = {
				...
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(Xt.a, {
					...
					placeholder: ui(ni(s, a, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_PAGE_URL_OPERATOR)),
					name: "description",
					type: "text",
					className: "has-dark-text height-two-rem",
					value: ni(s, a, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_PAGE_URL_VALUE),
					onChange: function(e) {
					...
					value: oi(s, a, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_RESOURCE_TYPE, si),
					onChange: function(e) {
						ci(s, i, a, e, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_RESOURCE_TYPE), E.RESOURCE_TYPE_MODIFIED()
					}
				})), c.a.createElement(me.a, {
					className: "my-auto",
					sm: "2",
					...
					options: ii,
					placeholder: "All (default)",
					value: oi(s, a, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_REQUEST_METHOD, ii),
					onChange: function(e) {
						return ci(s, i, a, e, S.CONSTANTS.PATH_FROM_PAIR.SOURCE_REQUEST_METHOD)
					}
				})), c.a.createElement(me.a, {
					className: "my-auto",
					sm: "2",
			...
			Ei = function(e) {
				...
				return Object(l.useLayoutEffect)((function() {
					o.loggedIn && o.details.profile && T()
				}), [o, T]), c.a.createElement(Xt.a, {
					className: "modal-dialog-centered ",
					isOpen: t,
					toggle: a,
					style: {
			...
			di = function(e) {
				...
				}, "Pick from Library")))))), E ? c.a.createElement(Ei, {
					isOpen: E,
					toggle: function() {
						d(!E)
					},
			...
			Si = function(e) {
				var t = e.pair,
					...
					n = e.helperFunctions,
					r = e.ruleDetails;
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(pi, {
					rowIndex: 1,
					pair: t,
					pairIndex: a,
					helperFunctions: n,
			...
			Ni = function(e) {
				var t = e.pair,
					...
					n = e.helperFunctions,
					r = e.ruleDetails;
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(Oi, {
					rowIndex: 1,
					pair: t,
					pairIndex: a,
					helperFunctions: n
			...
			Ci = function(e) {
				...
				return 0 === t.modifications.length && s(), c.a.createElement(c.a.Fragment, null, c.a.createElement(pi, {
					rowIndex: 1,
					pair: t,
					pairIndex: a,
					helperFunctions: n,
			...
			vi = function(e) {
				...
				return c.a.createElement(pe.a, {
					...
					placeholder: "None",
					value: function(e, t) {
						var n = Li(s.pairs[a], e, []);
						return t.filter((function(e) {
							return n.includes(e.value)
						}))
					}(S.CONSTANTS.PATH_FROM_PAIR.SCRIPT_LIBRARIES, _i()),
					onChange: function(e) {
		...
		var Di = function(e) {
				...
				return c.a.createElement("div", {
					...
					placement: "right",
					target: "pick-from-library"
				}, "Pick from Library")))))), p ? c.a.createElement(Ei, {
					isOpen: p,
					toggle: f,
					callback: O
					...
					xl: "10"
				}, c.a.createElement(Ui.Controlled, {
					style: {
						borderRadius: "5px"
					},
					value: r.value,
		...
		var xi = function(e) {
			...
			Ki = function(e) {
				var t = Object(l.useContext)(X),
					...
					d = function(e, t, a, n, l) {
						...
						Hi(s.pairs[t], a, c), l && l.forEach((function(e) {
							Hi(s.pairs[t], e.path, e.value)
						})), o(s)
					},
					p = function(e, t) {
						e && e.preventDefault();
					...
					T = function(e, t, a, n) {
						...
						var l = JSON.parse(JSON.stringify(r)),
							c = Yi(l.pairs[t], a);
						Hi(l.pairs[t], a, [].concat(Object(Rt.a)(c), [n])), o(l)
					},
					O = function(e, t, a, n) {
						e && e.preventDefault();
						var l = JSON.parse(JSON.stringify(r));
						Yi(l.pairs[t], a).splice(n, 1), o(l)
					};
				return r.pairs && 0 === r.pairs.length && Vi(r, e.currentlySelectedRuleConfig, a), c.a.createElement(c.a.Fragment, null, r.pairs ? r.pairs.map((function(t, a) {
					return c.a.createElement(pe.a, {
						key: t.id || a
					}, c.a.createElement("div", {
						...
						var n = {
							...
							generatePlaceholderText: Wi,
							openFilterModal: A,
							deletePair: p,
							getFilterCount: f,
							pushValueToArrayInPair: T,
			...
			$i = function(e) {
				...
				return c.a.createElement(me.a, {
					...
					onClick: function() {
						...
						E < a ? (Vi(s, t, n), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE_PAIRS, S.CONSTANTS.GA_EVENTS.ACTIONS.CREATED, "New.rule.pair.made", E)) : (L(a), T(e), g(Y.FEATURES.RULE_PAIRS), P(!0), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE_PAIRS, S.CONSTANTS.GA_EVENTS.ACTIONS.LIMIT_REACHED, "Rule.pairs.limit.reached", E))
					}
				}, c.a.createElement("span", {
					className: "btn-inner--icon"
				}, c.a.createElement(R.I, {
					color: Zi.PRIMARY_COLOR,
					size: "1.5em"
				})), c.a.createElement("span", {
					style: {
						color: Zi.PRIMARY_COLOR
			...
			eu = function(e) {
				...
				})) : null, c.a.createElement(me.a, null, c.a.createElement(zi, null)), c.a.createElement(me.a, {
					md: "7",
					xs: "12",
					sm: "6",
					className: " text-xl-right text-md-right text-lg-right "
				}, c.a.createElement(Ji, null))), c.a.createElement(pe.a, {
					className: "one-margin-bottom"
				}, c.a.createElement(Xi, {
					currentlySelectedRuleConfig: t
				}), t.ALLOW_ADD_PAIR ? c.a.createElement($i, {
					currentlySelectedRuleConfig: t
				}) : null), c.a.createElement(Ki, {
					currentlySelectedRuleConfig: t
				}))
			},
			tu = function(e) {
			...
			ou = function(e) {
				var t = Hs(e.location, e.isSharedListViewRule),
					a = t.MODE,
					...
					v = _[0],
					y = _[1],
					P = Object(l.useCallback)(Vs, [Vs]),
					U = Object(l.useCallback)(Gs, [Gs]),
					D = Object(l.useCallback)(Bs, [d]);
				if (Object(l.useEffect)((function() {
						!1 === E && (a === au.MODES.CREATE ? (D(i, d, n, Gs), P(i, nu[n], o)) : a === au.MODES.EDIT ? Kl(A).getRecord(r).then((function(e) {
							void 0 === e ? Fe(o) : T.current || (U(i, e), P(i, nu[e.ruleType], o))
						})) : a === au.MODES.SHARED_LIST_RULE_VIEW ? e.rule && (T.current || (U(i, e.rule), P(i, nu[e.rule.ruleType], o))) : Fe(o))
				...
				var w = {
					...
					planName: Ot(f),
					planRulePairLimit: bt(Y.FEATURES.RULE_PAIRS, Ot(f))
				};
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(pe.a, null, c.a.createElement("div", {
					className: "col"
				}, c.a.createElement(Se.a, null, a !== au.MODES.SHARED_LIST_RULE_VIEW ? c.a.createElement(Zs, {
					currentlySelectedRuleConfig: d,
					topCountShowRequiredDataObject: w,
					location: e.location
				}) : null, c.a.createElement(eu, {
					currentlySelectedRuleConfig: d,
			...
			Au = function(e) {
				var t = e.rules,
					...
					U = Object(l.useCallback)((function() {
						var e = {};
						iu(e, "".concat(pu, ".").concat(Eu), {}), iu(e, "".concat(pu, ".").concat(du), []), p.forEach((function(t) {
							iu(e, "".concat(t.id, ".").concat(Eu), t), iu(e, "".concat(t.id, ".").concat(du), [])
				...
				var t = e.rules,
					...
					f = [{
						...
						onClickHandler: function() {
							n && n.disableSelection || (fu(r, i), m(!i))
						}
					}, {
						columnData: "Fav"
					}, {
			...
			Ru = function(e) {
				...
				}, "click here"), "."), c.a.createElement("br", null), c.a.createElement("p", null, c.a.createElement("b", null, "Total Rules Exported: "), E.rulesCount, " ", c.a.createElement("br", null), c.a.createElement("b", null, "Total Groups Exported: "), E.groupsCount))) : c.a.createElement(Te, {
			...
			Iu = function(e) {
				...
				return Object(l.useLayoutEffect)((function() {
					...
					className: "one-padding-bottom  my-auto"
				}, c.a.createElement(Te, null))) : c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
					className: "modal-body one-padding-top zero-padding-bottom"
				}, c.a.createElement(pe.a, {
					className: "one-padding-bottom  my-auto"
				}, c.a.createElement(me.a, {
			...
			Lu = function() {
				var e = Object(l.useContext)(X),
					...
					p = d[0],
					A = d[1],
					f = Object(l.useState)(Y.FEATURES.RULES),
					T = Object(u.a)(f, 2),
					O = T[0],
					N = T[1],
					b = Object(l.useState)(0),
					...
					Le = function() {
						var e = Object(ea.a)($t.a.mark((function e() {
							...
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
										return e.next = 2, Kl().getAllRecords();
									case 2:
										t = e.sent, a = (new Date).getTime(), n = window.localStorage.getItem("authModalShownLastOn") || t.user_info.installationDate, r = (a - n) / 864e5, o.length >= 5 || r >= 15 ? (window.localStorage.setItem("authModalShownLastOn", a), Ie()) : V(!0);
									case 7:
									case "end":
										return e.stop()
								}
					...
					Ue = function() {
						...
						var e = Ot(r),
							t = bt(Y.FEATURES.SHARED_LISTS, e);
						_s(r.details.profile.uid).then((function(r) {
							Pe(r) >= t ? (C(t), A(e), N(Y.FEATURES.SHARED_LISTS), he(!0)) : (v(es(n)), Ne(!0), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.RULE, "rules", S.CONSTANTS.GA_EVENTS.ACTIONS.SHARED)), a(Ut("loadingModal", !1))
						}))
					},
					De = function(e) {
						r.loggedIn ? we() : Ie()
				...
				return window.clearRulesSelection = !1, Object(l.useEffect)((function() {
					return window.addEventListener("resize", Me),
						function() {
							return window.removeEventListener("resize", Me)
						}
					...
					})), r && r.details && r.details.profile ? _s(r.details.profile.uid).then((function(e) {
						var t = Pe(e);
					...
					className: "mb-0"
				}, "Manage Rules", " ", "bronze" === Ot(r) && U <= ke() ? "(".concat(U, "/").concat(ke(), " Rules Created)") : null, "bronze" === Ot(r) ? c.a.createElement("button", {
					className: "text-primary btn btn-link",
					style: {
						cursor: "pointer"
					},
					...
					className: "cursor-pointer"
				}, "Delete Rules")))) : null)) : null), c.a.createElement(Ou, null)))), B ? c.a.createElement(jo, {
					isOpen: B,
					toggle: Ce,
					onClickHandler: Ce
			...
			vu = function() {
				...
				return Object(l.useEffect)((function() {
					...
					Promise.all([e, t]).then((function(e) {
						var t = e[0],
							a = e[1];
						d(Lt(a, t)), E(!0), Ga(_u.ATTR.NUM_RULES, a.length), Ga(_u.ATTR.NUM_ACTIVE_RULES, a.filter((function(e) {
							return e.status === S.CONSTANTS.RULE_STATUS.ACTIVE
						})).length), Ga(_u.ATTR.NUM_GROUPS, t.length), Ga(_u.ATTR.NUM_ACTIVE_GROUPS, t.filter((function(e) {
							return e.status === S.CONSTANTS.GROUP_STATUS.ACTIVE
						})).length)
					}))
				}), [d, r, o]), c.a.createElement(c.a.Fragment, null, c.a.createElement(Po, null), m ? 0 !== n.length ? c.a.createElement(Lu, null) : c.a.createElement(zo, null) : c.a.createElement(Er, {
			...
			Uu = function() {
				var e = Object(l.useState)(""),
					...
					O = function(e) {
						e !== a && ("sync" === e && (s > 80 || d > 8e4) ? alert("Unable to change storage type. Too much data to be stored in Sync Storage.") : Bl(e).then((function(e) {
							T(), le.b.info("StorageType changed successfully!")
						})))
					};
				return Object(l.useEffect)((function() {
					f === S.CONSTANTS.APP_MODES.EXTENSION && T()
				}), [f]), f === S.CONSTANTS.APP_MODES.DESKTOP ? c.a.createElement(No, {
				...
				}, c.a.createElement(gi.b, null)))), c.a.createElement("p", {
					className: "mt-3  text-muted text-sm"
				}, c.a.createElement("span", {
					className: "text-nowrap"
					...
					className: "icon icon-shape bg-primary text-white rounded-circle shadow"
				}, c.a.createElement(gi.c, null)))), c.a.createElement("p", {
					className: "mt-3  text-muted text-sm"
				}, c.a.createElement("span", {
					className: "text-nowrap"
			...
			Bu = function(e) {
				var t = e.sharedListIdsToDeleteArray,
					...
					T = function() {
						return c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
							...
							className: "display-2"
						}, c.a.createElement(Mo.a, null)), c.a.createElement("h5", null, "Please select a list before deleting"))), f({
							showConfirmationBtn: !1
						}))
					},
				...
				return Object(l.useEffect)((function() {
					...
					xs: "12",
					className: "text-center"
				}, c.a.createElement("b", null, "Successfully deleted lists"))), f({
					showConfirmationBtn: !1
				})) : c.a.createElement(Te, {
					customLoadingMessage: "Deleting Lists"
				}) : ae()(t) ? T() : c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
					className: "modal-body "
				}, c.a.createElement(me.a, {
					lg: "12",
					md: "12",
					...
					className: "display-2"
				}, c.a.createElement(R.W, null)), c.a.createElement("b", null, "Are you sure to delete the selected lists?"), c.a.createElement("p", null, c.a.createElement("b", null, "Total Lists Selected: "), t.length, " ", c.a.createElement("br", null)))), f({
					showConfirmationBtn: !0
				})))
			},
			Vu = function(e) {
			...
			Hu = Y.SHARED_LISTS_TABLE_CONSTANTS.COLUMN_WIDTHS,
			Yu = [xu, ju, ku, Mu, Vu],
			Wu = function(e) {
				var t = e.sharedListId,
					a = e.sharedListDetails,
				...
				return c.a.createElement(c.a.Fragment, null, function(e, t, a, n) {
					return c.a.createElement(Tr.a, {
						...
						var l = r.isHovering;
						return c.a.createElement(c.a.Fragment, null, Yu.map((function(r, o) {
			...
			qu = function(e) {
				...
				}), [n, u]), c.a.createElement("tbody", null, ae()(E) ? c.a.createElement(Ku, null) : E.map((function(e) {
					return c.a.createElement(Wu, {
						key: e[0],
						sharedListId: e[0],
			...
			$u = function() {
				var e = Object(l.useContext)(X).state,
					...
					p = Object(l.useCallback)((function(e) {
						_s(e.details.profile.uid).then((function(e) {
							d(e), s(!1), e && Ga(Zu.ATTR.NUM_SHARED_LISTS, Object.keys(e).length), e || Ga(Zu.ATTR.NUM_SHARED_LISTS, 0)
						}))
					}), []);
				...
				}) : ae()(E) ? c.a.createElement(Xu, null) : c.a.createElement(Ju, {
					sharedLists: E
				})
			},
			em = function(e) {
			...
			nm = function() {
				var e = Object(l.useContext)(X),
					...
					p = d[0],
					A = d[1],
					f = Object(l.useCallback)(a, []),
					T = window.location.pathname.split("/")[am.SHARED_LISTS.VIEWER.ABSOLUTE.split("/").length + 1 - 1].split("-")[0];
				Object(l.useEffect)((function() {
					var e = Kl(r).getRecords(S.CONSTANTS.OBJECT_TYPES.GROUP),
						t = Kl(r).getRecords(S.CONSTANTS.OBJECT_TYPES.RULE);
					Promise.all([e, t]).then((function(e) {
				...
				return Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.SHARED_LIST, S.CONSTANTS.GA_EVENTS.ACTIONS.VIEWED, "SharedList Index Page Viewed"), Object(l.useLayoutEffect)((function() {
					O()
				}), [O]), c.a.createElement(c.a.Fragment, null, ae()(i) ? null : c.a.createElement(tm, {
					rules: i,
					groups: p
				}))
			},
			rm = function(e) {
				...
				return Object(oe.a)(a, [{
					key: "render",
					value: function() {
						return c.a.createElement(c.a.Fragment, null, c.a.createElement(ue, null), c.a.createElement(nm, null))
					}
				}]), a
			}(c.a.Component),
			lm = function(e) {
			...
			om = function() {
				...
				return tt(t) ? c.a.createElement(c.a.Fragment, null, c.a.createElement(re.a, {
					...
					fluid: !0
				}, c.a.createElement(pe.a, null, c.a.createElement(cm, {
			...
			sm = function() {
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(ue, null), c.a.createElement(om, null))
			},
			im = function(e) {
				var t = e.isOpen,
					a = e.toggleModal,
				...
				return c.a.createElement(Xt.a, {
					...
					type: "button",
					onClick: function() {
						return d(!0), void fe.functions().httpsCallable("updateTeamUserRole")({
							teamId: r,
							userId: n,
							role: o ? "user" : "admin"
						}).then((function(e) {
			...
			um = function(e) {
				...
				return c.a.createElement(Xt.a, {
					...
					type: "button",
					onClick: function() {
						return E(!0), void fe.functions().httpsCallable("updateTeamUserRole")({
							teamId: r,
							userId: n,
							role: "remove"
						}).then((function(e) {
			...
			mm = function(e) {
				var t = e.teamId,
					...
					b = N[0],
					g = N[1],
					h = fe.functions().httpsCallable("getTeamUsers"),
				...
				return Object(l.useEffect)((function() {
					...
					v()
				}), [v, a]), c.a.createElement(c.a.Fragment, null, Object(Oe.isEmpty)(d) ? c.a.createElement(Te, {
					...
					userId: f.userId,
					teamId: t,
					isCurrentlyAdmin: f.isCurrentlyAdmin,
			...
			Em = function(e) {
				...
				return c.a.createElement(Xt.a, {
					...
					type: "button",
					onClick: function() {
						return E(!0), void fe.functions().httpsCallable("inviteEmailToTeam")({
							teamId: n,
							email: r,
							isAdmin: o
						}).then((function(e) {
			...
			pm = function(e) {
				...
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(Xt.a, {
					...
					value: p,
					onChange: function(e) {
						S(!p), Ma(dm.CATEGORIES.TEAMS, dm.ACTIONS.WORKFLOW_STARTED, "Check for Admin access to Team else made admin")
					}
				}), c.a.createElement("label", {
					className: "custom-control-label",
					htmlFor: "makeAdmin"
					...
					onClick: function() {
						return function() {
							if (!An()(i)) return le.b.warn("Please enter a valid email"), void Ma(dm.CATEGORIES.TEAMS, dm.ACTIONS.ERROR, "Email entered is not Valid");
							var e = fe.functions().httpsCallable("addUserToTeam");
							h(!0), e({
								teamId: n,
								email: i,
								isAdmin: p
							}).then((function(e) {
								h(!1), r && r(), a(), Ma(dm.CATEGORIES.TEAMS, dm.ACTIONS.FORM_SUBMITTED, "Successfully added member in team")
							})).catch((function(e) {
								h(!1), "user-not-found" === e.message ? (O(!0), Ma(dm.CATEGORIES.TEAMS, dm.ACTIONS.ERROR, "Add member User Not found error")) : "user-already-exists" === e.message ? (le.b.warn("User already has access to the team"), a(), Ma(dm.CATEGORIES.TEAMS, dm.ACTIONS.ERROR, "User already has access to the team")) : (le.b.warn("Trouble adding user"), Ma(dm.CATEGORIES.TEAMS, dm.ACTIONS.ERROR, "Trouble adding user"))
							}))
						}()
					},
					disabled: g
					...
					className: "icon-spin"
				}), " Adding Member") : c.a.createElement("span", null, "Add Member")))), T ? c.a.createElement(Em, {
					isOpen: T,
					toggleModal: function() {
						O(!T), a()
					},
			...
			Am = function(e) {
				...
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(pe.a, null, c.a.createElement(me.a, null, c.a.createElement(Se.a, {
					...
					type: "button",
					onClick: function() {
						o(!0), Ma(Sm.CATEGORIES.TEAMS, Sm.ACTIONS.CLICKED, "Add Member in Team button clicked")
					}
				}, c.a.createElement("span", {
					className: "btn-inner--icon"
				}, c.a.createElement(R.H, null)), c.a.createElement("span", {
			...
			gm = function(e) {
				var t = e.teamId,
					...
					I = function(e, n) {
						...
						}, "".concat(E).concat(l[Nm(O)] || "0"), c.a.createElement("small", {
							className: "text-muted"
						}, "/".concat(Om(o))))), c.a.createElement("div", {
							...
							onClick: function(n) {
								! function(e, n) {
									...
									if (r || s) xe({
										...
										planType: c,
										days: o
									}), Ma(fm.CATEGORIES.PRICING, fm.ACTIONS.CLICKED, "Clicked Select button of Mini Pricing Table Redirecting@Checkout");
									else if (A(!0), "team" === a) fe.functions().httpsCallable("createTeamSubscription")({
										rqPlanId: l,
										teamId: t,
										currency: Nm(O)
									}).then((function(e) {
										if (!m.current) return null;
										var a = e.data;
										a.success ? (Ue(i, t), Ma(fm.CATEGORIES.REQUEST_UPGRADE, fm.ACTIONS.UPDATED, "Updated Existing Team Subscription")) : (A(!1), le.b.error(a.message), Ma(fm.CATEGORIES.REQUEST_UPGRADE, fm.ACTIONS.ERROR, "Error occureed while updating existing team subscription", {
											error: a.message
										}))
									})).catch((function(e) {
										if (!m.current) return null;
										A(!1), le.b.error(e.message), Ma(fm.CATEGORIES.REQUEST_UPGRADE, fm.ACTIONS.ERROR, "Error occureed while updating existing team subscription", {
											error: e.message
										})
									}));
									else if ("individual" === a) {
										fe.functions().httpsCallable("createIndividualSubscription")({
											rqPlanId: l,
											teamId: t || null,
											currency: Nm(O)
										}).then((function(e) {
											if (!m.current) return null;
											var t = e.data;
											t.success ? (we(i, !0, !0), Ma(fm.CATEGORIES.REQUEST_UPGRADE, fm.ACTIONS.UPDATED, "Updated Existing Individual Subscription")) : (A(!1), 0 === t.message.indexOf("This customer has no attached payment source or default payment method") ? Me({
												mode: "individual"
											}) : (le.b.error(t.message), Ma(fm.CATEGORIES.REQUEST_UPGRADE, fm.ACTIONS.ERROR, "Error occureed while updating existing Individual subscription", {
												error: t.message
											})))
										})).catch((function(e) {
											if (!m.current) return null;
											A(!1), le.b.error(e.message), Ma(fm.CATEGORIES.REQUEST_UPGRADE, fm.ACTIONS.ERROR, "Error occureed while updating existing Individual subscription", {
												error: e.message
											})
										}))
									}
					...
					_ = Object(l.useCallback)((function() {
						fe.functions().httpsCallable("getTeamInfo")({
							teamId: t
						}).then((function(e) {
							if (!m.current) return null;
							var t = e.data;
							...
							if (!m.current) return null;
							e && (le.b.error("This link has been expired. Please retry."), Ma(fm.CATEGORIES.PAGE_VISITS, fm.ACTIONS.ROUTE_VIEWED, "link expired Redirected to 404 from teams page"), Fe(i))
						}))
					}), [t]),
					v = Object(l.useCallback)((function() {
						fe.functions().httpsCallable("fetchIndividualUserSubscriptionDetails")().then((function(e) {
							if (!m.current) return null;
							!1 === e.data.success && (Ma(fm.CATEGORIES.PAGE_VISITS, fm.ACTIONS.ROUTE_VIEWED, "Redirected to 404 from teams page"), Fe(i));
							var t = e.data.data;
							"active" === t.status && C(t.rqPlanId)
						})).catch((function(e) {
							if (!m.current) return null;
							le.b.error("This link has been expired. Please retry."), Ma(fm.CATEGORIES.PAGE_VISITS, fm.ACTIONS.ROUTE_VIEWED, "link expired Redirected to Account details from teams page"), Pe(i)
						}))
					}), []);
				return Object(l.useEffect)((function() {
					return L(),
			...
			hm = function(e) {
				var t = e.teamId,
					...
					r = n[0],
					o = n[1];
				return c.a.createElement(c.a.Fragment, null, r ? c.a.createElement(gm, {
					teamId: t,
					isNewSubscription: !0,
					mode: "team"
				}) : c.a.createElement(pe.a, null, c.a.createElement(me.a, {
					...
					color: "primary",
					onClick: function() {
						o(!0), Ma(Rm.CATEGORIES.TEAMS, Rm.ACTIONS.CLICKED, "Clicked View Plans button on Team Info page redirected@mini pricing table")
					}
				}, "View Plans"), c.a.createElement(de.a, {
					color: "secondary",
					onClick: function() {
						window.open(Y.PATHS.PRICING.ABSOLUTE), Ma(Rm.CATEGORIES.TEAMS, Rm.ACTIONS.CLICKED, "Clicked Learn More button on Team Info page redirected@Pricing table")
					}
				}, "Learn More"))))))
			},
			Cm = function(e) {
				var t = e.teamId,
					...
					d = m[1],
					p = Object(l.useCallback)((function() {
						d(!0), fe.functions().httpsCallable("getTeamSubscriptionInfo")({
							teamId: t
						}).then((function(e) {
				...
				return Object(l.useEffect)((function() {
				...
				}), [p]), c.a.createElement(c.a.Fragment, null, c.a.createElement(pe.a, null, c.a.createElement(me.a, null, E ? c.a.createElement(Te, {
					...
					className: "border-0"
				}, o.subscriptionStatus ? c.a.createElement(Tc, {
					mode: "team",
					teamId: t
			...
			Lm = function(e) {
				...
				var r = Object(l.useState)(""),
					...
					P = v[1],
					U = Object(l.useCallback)((function() {
						P(!0), fe.functions().httpsCallable("getTeamInfo")({
							teamId: t
						}).then((function(e) {
							if (!n.current) return null;
							var t = e.data;
							if (!t.success) throw new Error(t.message);
							var a = t.data;
							i(a.name), p(new Date(1e3 * a.creationTime._seconds).toDateString()), T(a.subscriptionStatus), L(new Date(1e3 * a.subscriptionCurrentPeriodStart).toDateString()), g(new Date(1e3 * a.subscriptionCurrentPeriodEnd).toDateString()), P(!1)
						})).catch((function(e) {
							if (!n.current) return null;
							e && (le.b.error("This link has been expired. Please retry."), Ma(Im.CATEGORIES.PAGE_VISITS, Im.ACTIONS.ROUTE_VIEWED, "Redirected to 404 from team info page"), Fe(a))
						}))
					}), [t]);
				return Object(l.useEffect)((function() {
					return U(),
					...
					className: "mb-0"
				}, "Team Details")), "active" === f ? c.a.createElement(me.a, {
					xs: "12",
					xl: "6",
					lg: "6",
					md: "6",
					...
					onClick: function() {
						ke({
							...
							planType: "enterprise",
							teamId: t
						}), Ma(Im.CATEGORIES.TEAMS, Im.ACTIONS.CLICKED, "Change Plan button clicked redirected to update subscription")
					}
				}, c.a.createElement("span", {
					className: "btn-inner--icon"
				}, c.a.createElement(R.N, {
					...
					className: "btn-inner--text"
				}, "Change Plan"))) : null, "canceled" === f || "incomplete_expired" === f ? c.a.createElement(me.a, {
					xs: "12",
					xl: "6",
					lg: "6",
					md: "6",
					...
					onClick: function() {
						ke({
							...
							teamId: t,
							isRenewal: !0
						}), Ma(Im.CATEGORIES.TEAMS, Im.ACTIONS.CLICKED, "Renew Subscription button clicked redirected to update subscription")
					}
				}, c.a.createElement("span", {
					className: "btn-inner--icon"
				}, c.a.createElement(R.U, {
					...
					className: "btn-inner--text"
				}, "Renew Subscription"))) : null)), y ? c.a.createElement(Ae.a, null, c.a.createElement(Te, {
					...
					className: "font-weight-bold"
				}, "Created on: "), d)), !f || Object(Oe.isEmpty)(f) ? null : c.a.createElement(pe.a, null, c.a.createElement(me.a, null, c.a.createElement("span", {
					className: "font-weight-bold"
				}, "Current Period:"), " ".concat(I, " ~ ").concat(b)), c.a.createElement(me.a, {
					className: "text-right"
				}, c.a.createElement("span", {
					className: "font-weight-bold"
				}, "Subscription Status: "), cn(f)))))
			},
			_m = function(e) {
				var t = e.teamId;
				return c.a.createElement(re.a, {
					...
					className: "mb-0"
				}, "Manage Team")))), c.a.createElement(Ae.a, null, c.a.createElement(Lm, {
					teamId: t
				}), c.a.createElement(Am, {
					teamId: t
				...
				var e = Object(l.useContext)(X).state,
					...
					ee = function(e, t) {
						d(t), Pa(["customProfile", r.uid], {
							position: e
						}), Ma(ym.CATEGORIES.UNLOCK, ym.ACTIONS.CLICKED, e), Ga(ym.ATTR.PROFILE, e)
					},
					te = function(e, t) {
						switch (e.preventDefault(), Ma(ym.CATEGORIES.UNLOCK, ym.ACTIONS.CLICKED, t), t) {
					...
					ae = function() {
						E && A && N && C && v && D && k ? ia(r.email) ? (Z(!0), Pa(["unlock", r.uid], {
							...
							fe.functions().httpsCallable("unlockPremium")({
								userId: r.uid,
								email: r.email,
			...
			xm = function() {
				...
				return Object(l.useEffect)((function() {
					var e, t = Hn();
					t.oobCode && !d && A.loggedIn && (p(!0), n(t.continueUrl), (e = t.oobCode, fe.auth().applyActionCode(e)).then((function(e) {
						i(!0), fa(A.details.profile.uid, !0), Ma(Dm.CATEGORIES.USER, Dm.ACTIONS.EMAIL_VERIFICATION_SUCCESSFUL, "".concat(Dm.CATEGORIES.USER, "_").concat(Dm.ACTIONS.EMAIL_VERIFICATION_SUCCESSFUL))
					})).catch((function(e) {
						console.log(e), i(!1), Ma(Dm.CATEGORIES.USER, Dm.ACTIONS.EMAIL_VERIFICATION_FAILED, "".concat(Dm.CATEGORIES.USER, "_").concat(Dm.ACTIONS.EMAIL_VERIFICATION_FAILED))
					})))
			...
			jm = function(e) {
				...
				return Object(oe.a)(a, [{
					key: "render",
					value: function() {
						return c.a.createElement(c.a.Fragment, null, c.a.createElement(ue, null), c.a.createElement(xm, null))
					}
				}]), a
			}(c.a.Component),
			km = function() {
			...
			Mm = function(e) {
				...
				return Object(oe.a)(a, [{
					key: "render",
					value: function() {
						return c.a.createElement(c.a.Fragment, null, c.a.createElement(ue, null), c.a.createElement(km, null))
					}
				}]), a
			}(c.a.Component),
			Gm = a(206),
			...
			Bm = function() {
						...
						var n = Object(ea.a)($t.a.mark((function n(r) {
							...
							return $t.a.wrap((function(n) {
								for (;;) switch (n.prev = n.next) {
									...
									case 12:
										u = n.sent, m = u.error, E = u.paymentMethod, m ? (C(m.message), l = !0) : c = E.id, d = "individual" === o ? "updateIndividualPaymentMethod" : "updateTeamPaymentMethod", l ? A(!1) : fe.functions().httpsCallable(d)({
											teamId: s || !1,
											paymentMethodId: c
										}).then((function(t) {
				...
				return Object(l.useEffect)((function() {
				...
				}), j ? c.a.createElement(Te, null) : U ? c.a.createElement("div", {
					className: "row justify-content-md-center"
				}, c.a.createElement("div", {
					className: "col col-sm-12 col-md-8 col-lg-8 col-xl-6"
				}, c.a.createElement("div", {
					...
					className: "icon-spin"
				}) : c.a.createElement(c.a.Fragment, null, "Save")))) : c.a.createElement(Fm.a, {
					style: {
						background: "transparent"
					},
					className: "text-center"
			...
			Vm = function() {
				...
				return Object(l.useEffect)((function() {
					...
					stripe: a
				}, c.a.createElement(Bm, null)) : null), c.a.createElement(pe.a, null, c.a.createElement(me.a, {
					className: "text-center"
				}))))))))))
			},
			Hm = function() {
			...
			aE = function() {
				var e = Object(l.useContext)(X),
					...
					v = function(e) {
						...
						d(Object(E.a)(Object(E.a)({}, m), {}, {
							...
							} else t.metadata && t.metadata.closeConfirmRequired ? (b(e), f(!0)) : le.b.error("Unable to activate ".concat(g[e].name, ". Issue reported."))
						})).catch((function(e) {
							return console.log(e)
						}))
					},
				...
				}, "here"), " ", "to manually set proxy and install certificate."))), A ? c.a.createElement(tE, {
					isOpen: A,
					toggle: function() {
						A ? (b(!1), f(!1)) : f(!0)
					},
				...
				}) : null) : c.a.createElement(pe.a, null, c.a.createElement(Te, {
			...
			uE = function() {
				...
				if (d.timestamp) {
					...
					for (var f = 0, T = Object.entries(d.request.headers); f < T.length; f++) {
						var O = Object(u.a)(T[f], 2),
							N = {
								property: O[0],
								value: O[1]
							};
			...
			mE = function() {
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(pe.a, null, c.a.createElement(me.a, null, c.a.createElement(nE.a, {
					color: "primary",
					fade: !1
				}, c.a.createElement("span", {
					className: "alert-inner--icon"
					...
					className: "alert-inner--text"
				}, "To optimize performance, logger works only when this screen is open & only 50 most recent logs are shown.")))), c.a.createElement(pe.a, null, c.a.createElement(me.a, null, c.a.createElement(uE, null))))
			},
			EE = function() {
				return c.a.createElement("div", {
					className: "row"
			...
			dE = function() {
				...
				return c.a.createElement(c.a.Fragment, null, c.a.createElement("div", {
					...
					pills: !0,
					role: "tablist"
				}, c.a.createElement(zm.a, null, c.a.createElement(Jm.a, {
					"aria-selected": 1 === a,
					className: eE()("mb-sm-3 mb-md-0", {
						active: 1 === a
					}),
					onClick: function(e) {
						return r(e, 1)
				...
				}), "Apps")), c.a.createElement(zm.a, null, c.a.createElement(Jm.a, {
					"aria-selected": 2 === a,
					className: eE()("mb-sm-3 mb-md-0", {
						active: 2 === a
					}),
					...
					className: "has-no-box-shadow"
				}, c.a.createElement(Ae.a, null, c.a.createElement(Xm.a, {
					activeTab: "tabs" + a
				}, c.a.createElement(Zm.a, {
					tabId: "tabs1"
				}, 1 === a ? c.a.createElement(aE, null) : null), c.a.createElement(Zm.a, {
					tabId: "tabs2"
				}, 2 === a ? c.a.createElement(mE, null) : null), c.a.createElement(Zm.a, {
					tabId: "tabs3"
				}, 3 === a ? c.a.createElement(EE, null) : null)))))
			},
			pE = function() {
				var e = Object(ee.g)(),
					t = Object(l.useContext)(X).state,
				...
				return a === S.CONSTANTS.APP_MODES.EXTENSION && ge(e), n ? c.a.createElement(c.a.Fragment, null, c.a.createElement("section", null, c.a.createElement(c.a.Fragment, null, c.a.createElement(re.a, {
					...
					className: "col"
				}, c.a.createElement(Se.a, null, c.a.createElement(Ae.a, null, c.a.createElement(dE, null))))))))) : c.a.createElement(Te, {
					customLoadingMessage: "Loading background process"
				})
			},
			SE = function() {
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(pE, null))
			},
			AE = a(209),
			fE = a.n(AE),
			TE = a(534),
			...
			bE = function() {
				...
				return Object(l.useEffect)((function() {
					...
					return m && 0 === e.length && !A ? "true" === m.isvisitmarketplacetask ? (f(!0), k((function(e) {
						return e + 1
					}))) : f(!1) : e.length && !A ? (f(!0), Ga("isVisitMarketplaceTask", !0), Ma(S.CONSTANTS.GA_EVENTS.CATEGORIES.ONBOARDING, S.CONSTANTS.GA_EVENTS.ACTIONS.TASK_COMPLETED, "marketplace rule task completed"), k((function(e) {
						return e + 1
					}))) : void 0
					...
					className: "text-justify"
				}, "Intercept ", "&", " Modify HTTP Requests, Setup redirects, modify headers, switch hosts, insert user scripts and much more. Used by 125K developers from 500 organizations around the globe."))))), c.a.createElement(NE, {
					progressBarCount: j
				}), c.a.createElement("div", {
					...
					"aria-label": "congratulations",
					role: "img"
				}, "\ud83e\udd73"), " ", "Hurray, you've completed all the tasks"), c.a.createElement(Ae.a, null, c.a.createElement(pe.a, null, c.a.createElement(OE, {
			...
			hE = function() {
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(re.a, {
					...
					className: " shadow"
				}, c.a.createElement(Ae.a, null, c.a.createElement(RE, null)))))))
			},
			CE = function() {
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(ue, null), c.a.createElement(hE, null))
			},
			IE = Y.PATHS,
			LE = Y.AUTH,
			_E = [{
				path: IE.RULE_EDITOR.RELATIVE,
				name: "Rule Editor",
				...
				path: IE.SHARED_LISTS.VIEWER.RELATIVE,
				...
				path: IE.LICENSE.MANAGE.RELATIVE,
				name: "Manage License",
				icon: "ni ni-lock-circle-open text-red",
				component: Tl,
				layout: IE.DASHBOARD,
				...
				path: IE.SETTINGS.REMOTE_RULES.RELATIVE,
				name: "Settings",
				icon: "ni ni-lock-circle-open text-red",
				component: Ro,
				layout: IE.DASHBOARD,
				...
				path: IE.ACCOUNT.TEAM.RELATIVE + "/:teamId",
				name: "Manage Team",
				icon: "ni ni-lock-circle-open text-red",
				component: vm,
				layout: IE.DASHBOARD,
				...
				path: IE.ACCOUNT.MY_TEAMS.RELATIVE,
				icon: "ni ni-lock-circle-open text-red",
				component: uc,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1
			}, {
				path: IE.ACCOUNT.PERSONAL_SUBSCRIPTION.RELATIVE,
				icon: "ni ni-lock-circle-open text-red",
				component: Nc,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1
			}, {
				path: IE.ACCOUNT.UPDATE_SUBSCRIPTION.RELATIVE,
				icon: "ni ni-lock-circle-open text-red",
				component: Wm,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1
			}, {
				path: IE.ACCOUNT.UPDATE_SUBSCRIPTION_CONTACT_US.RELATIVE,
				icon: "ni ni-lock-circle-open text-red",
				component: qm,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1
			}, {
				path: IE.ACCOUNT.UPDATE_PAYMENT_METHOD.RELATIVE,
				icon: "ni ni-lock-circle-open text-red",
				component: Hm,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1
			}, {
				path: IE.ACCOUNT.REFRESH_SUBSCRIPTION.RELATIVE,
				icon: "ni ni-lock-circle-open text-red",
				component: Oo,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1
			}, {
				path: IE.ACCOUNT.CHECKOUT.RELATIVE,
				...
				showLinkInSidebar: !1,
				props: {
					authMode: LE.ACTION_LABELS.LOG_IN
				}
			}, {
				path: IE.AUTH.DEKSTOP_SIGN_IN.RELATIVE,
				name: "Sign In",
				icon: "ni ni-lock-circle-open text-red",
				component: Xn,
				layout: IE.DASHBOARD,
				...
				showLinkInSidebar: !1,
				props: {
					authMode: LE.ACTION_LABELS.SIGN_UP
				}
			}, {
				path: IE.AUTH.FORGOT_PASSWORD.RELATIVE,
				...
				showLinkInSidebar: !1,
				props: {
					authMode: LE.ACTION_LABELS.REQUEST_RESET_PASSWORD
				}
			}, {
				path: IE.AUTH.EMAIL_ACTION.RELATIVE,
				name: "Email Action",
				icon: "ni ni-lock-circle-open text-red",
				component: fr,
				layout: IE.DASHBOARD,
				...
				path: IE.AUTH.RESET_PASSWORD.RELATIVE,
				name: "Reset Password",
				icon: "ni ni-lock-circle-open text-red",
				component: zn,
				layout: IE.DASHBOARD,
				showLinkInSidebar: !1,
				props: {
					authMode: LE.ACTION_LABELS.DO_RESET_PASSWORD
				}
			}, {
				path: IE.AUTH.VERIFY_EMAIL.RELATIVE,
				name: "Verify E-mail",
				icon: "ni ni-lock-circle-open text-red",
				component: jm,
				layout: IE.DASHBOARD,
				...
				path: IE.AUTH.EMAIL_LINK_SIGNIN.RELATIVE,
				...
				path: IE.PAYMENT_SUCCESS.RELATIVE,
				...
				path: IE.ACCEPT_TEAM_INVITE.RELATIVE,
				name: "Join a Team",
				icon: "ni ni-lock-circle-open text-red",
				component: Mt,
				layout: IE.DASHBOARD,
				...
				path: IE.ACCOUNT.SUPPORT.RELATIVE,
				...
				path: IE.DESKTOP.MANUAL_SETUP.RELATIVE,
				name: "Manual Setup",
				icon: "ni ni-support-16 text-red",
				component: CE,
				layout: IE.DASHBOARD,
			...
			xE = function() {
				...
				}, "Use Requestly with"), c.a.createElement(wE.a, {
			...
			ME = function(e) {
				...
				return c.a.createElement(jE, {
					...
					ctaIconPostion: "end",
					currentPath: a,
					blackListPaths: [kE.AUTH.VERIFY_EMAIL.RELATIVE],
					dismissible: !1
				})
			},
			GE = a(131),
			FE = function() {
				...
				}), [n, window.location.pathname]), c.a.createElement(c.a.Fragment, null, s ? c.a.createElement(c.a.Fragment, null, c.a.createElement(GE.a, {
					placement: "bottom",
					isOpen: d,
					target: "tooltip"
			...
			WE = function(e) {
				var t = e.backToMainLink || "/",
					...
					j = Object(l.useCallback)((function(e) {
						switch ("/" === e[e.length - 1] && (e = e.slice(0, -1)), e) {
							case YE.RULES.ABSOLUTE:
								return "rules";
							case YE.FILES.ABSOLUTE:
								return "files";
							case YE.SHARED_LISTS.ABSOLUTE:
								return "sharedLists";
							case YE.MARKETPLACE.ABSOLUTE:
								return "marketplace";
							default:
								return !1
						}
				...
				return Object(l.useEffect)((function() {
					...
					C.loggedIn && !T && (O(!0), (t = a.uid, t ? Da.getValue(["customProfile", t, "signup"]).then(function() {
						var e = Object(ea.a)($t.a.mark((function e(a) {
							return $t.a.wrap((function(e) {
								for (;;) switch (e.prev = e.next) {
									case 0:
				...
				}), [C.loggedIn, C.details, T, x, j, e.location.pathname, p]), c.a.createElement(c.a.Fragment, null, c.a.createElement("nav", {
					className: "navbar navbar-top navbar-expand navbar-dark bg-gradient-blue border-bottom-0"
				}, c.a.createElement("div", {
					className: "container-fluid"
				}, c.a.createElement("div", {
					...
					placeholder: "Search ".concat(VE(HE(o))),
					type: "text",
					value: BE(h, o, ""),
					onChange: P
					...
					component: "navbar"
				})), C.details.profile || C.details || C.loggedIn ? c.a.createElement(FE, null) : null, I === S.CONSTANTS.APP_MODES.DESKTOP ? null : c.a.createElement(xE, null)), c.a.createElement(yE, null)))), C.loggedIn ? d ? null : c.a.createElement(ME, {
					resendVerificationEmailHandler: Oa,
					currentPath: e.location.pathname
				}) : null)
			},
			KE = Y.LINKS,
			qE = parseInt(162987.7075799) % 1e4,
			QE = function(e) {
				Object(se.a)(a, e);
				var t = Object(ie.a)(a);
				...
				return Object(oe.a)(a, [{
					...
					value: function() {
						return c.a.createElement("footer", {
							...
							href: KE.REQUESTLY_GITHUB_ISSUES,
							rel: "noopener noreferrer",
							target: "_blank"
						}, "Report Issue")), c.a.createElement(zm.a, null, c.a.createElement(Jm.a, {
							href: KE.REQUESTLY_DESKTOP_APP,
							rel: "noopener noreferrer",
							target: "_blank"
						}, "Get Desktop App")), c.a.createElement(zm.a, null, c.a.createElement(Jm.a, {
							href: KE.REQUESTLY_BLOG,
							rel: "noopener noreferrer",
							target: "_blank"
						}, "Blog")), c.a.createElement(zm.a, null, c.a.createElement(Jm.a, {
							href: KE.REQUESTLY_PRIVACY_POLICY,
							rel: "noopener noreferrer",
							target: "_blank"
						...
						}, c.a.createElement("span", null, "Build ".concat(qE, " ").concat("8/25/2021")))))
					}
				}]), a
			}(c.a.Component),
			zE = Y.LINKS,
			JE = function(e) {
				var t, a = e.routes,
					...
					O = f[1];
				Object(l.useLayoutEffect)((function() {
					m.details.isLoggedIn && m.details.planDetails ? (S(Tt(m.details.planDetails)), O(pt(m))) : (O(!1), S(!1))
				}), [m]);
				...
				return c.a.createElement("nav", {
					...
					target: "_blank",
					href: zE.REQUESTLY_DOCS
				}, c.a.createElement("i", {
					className: "ni ni-book-bookmark"
				}), c.a.createElement("span", {
					className: "nav-link-text"
				}, "Docs"))), c.a.createElement(zm.a, {
					className: ""
				}, c.a.createElement(Jm.a, {
					target: "_blank",
					...
					className: "sidebar-plan-info-text"
				}, "Premium")) : c.a.createElement(Jm.a, {
					onClick: function() {
						return ye(o)
					},
					className: "sidebar-plan-info-navlink "
			...
			ed = function(e) {
				...
				var i = function(e) {
					...
					for (var r = 0; r < _E.length; r++) e === _E[r].layout.concat(_E[r].path).replace(/\/\//g, "/") && (t = _E[r].name);
					return {
				...
				return c.a.createElement(c.a.Fragment, null, c.a.createElement(le.a, {
					...
					draggable: !0,
					pauseOnHover: !1
				}), c.a.createElement(JE, Object.assign({}, e, {
					routes: _E,
					logo: {
						innerLink: $E.ROOT,
						imgSrc: a(495),
				...
				}, c.a.createElement(WE, Object.assign({}, e, {
					brandText: i.title,
					backToMainLink: i.backToMainLink
				})), c.a.createElement(ee.d, null, _E.map((function(e, t) {
					if (e.layout === $E.DASHBOARD) {
						var a = e.props || {};
					...
					from: $E.EXTENSION_INSTALLED,
					to: $E.RULES.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: $E.ANY,
					to: $E.PAGE404.ABSOLUTE
				})), c.a.createElement(re.a, {
					fluid: !0
				}, c.a.createElement(QE, null))), o.loadingModal.isActive ? c.a.createElement(XE, {
					isOpen: o.loadingModal.isActive,
					toggle: function() {
						r(Ut("loadingModal"))
					}
				}) : null, o.authModal.isActive ? c.a.createElement(ZE, Object.assign({
			...
			cd = function() {
				...
				if (Object(l.useEffect)((function() {
						s || (i(!0), ne.a.auth().onAuthStateChanged((function(e) {
							e ? (ya(["userSubscriptions", e.uid, "planDetails"]).then((function(t) {
								a(ht(!0, {
									...
									function(e) {
										return e && St(e.planId) && !Tt(e) && ("active" === e.status || "referral" === e.type)
								...
								console.error("Unable to fetch user plan", e.message), a(ht(!1, !1)), p || (S(!0), rd())
					...
					}), [a]), ae()(window.location.hash)) return c.a.createElement(c.a.Fragment, null, c.a.createElement(nd, null), c.a.createElement(ee.d, null, c.a.createElement(ee.b, {
					path: ld.LANDING,
					render: function(e) {
						return c.a.createElement(ad, e)
					}
				}), c.a.createElement(ee.b, {
					path: ld.DASHBOARD,
					render: function(e) {
						return c.a.createElement(ed, e)
					}
				}), c.a.createElement(ee.a, {
					from: ld.EXTENSION_INSTALLED,
					to: ld.RULES.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.GOODBYE.RELATIVE,
					to: ld.FEEDBACK.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.FILES_LIBRARY.ABSOLUTE + "/:id",
					to: ld.FILES.VIEWER.ABSOLUTE + "/:id"
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.PRICING.ABSOLUTE,
					to: ld.PRICING.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.LICENSE.MANAGE.ABSOLUTE,
					to: ld.LICENSE.MANAGE.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.LICENSE.ABSOLUTE,
					to: ld.LICENSE.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.SETTINGS.REMOTE_RULES.ABSOLUTE,
					to: ld.SETTINGS.REMOTE_RULES.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.SETTINGS.ABSOLUTE,
					to: ld.SETTINGS.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.UNLOCK_PREMIUM.ABSOLUTE,
					to: ld.UNLOCK_PREMIUM.ABSOLUTE
				}), c.a.createElement(ee.a, {
					from: ld.LEGACY.GOODBYE.ABSOLUTE,
					to: ld.GOODBYE.ABSOLUTE
				}), c.a.createElement(ee.a, {
					exact: !0,
					from: ld.ROOT,
					to: ld.RULES.ABSOLUTE
				...
				var A = window.location.hash.split("/"),
					...
					T = A[1];
				switch (f) {
					case ld.HASH.SHARED_LISTS:
						window.location.assign(ld.SHARED_LISTS.VIEWER.ABSOLUTE + "/" + T);
						break;
					case ld.HASH.RULE_EDITOR:
						window.location.replace(ld.RULE_EDITOR.EDIT_RULE.ABSOLUTE + "/" + T)
				}
			};
		s.a.render(c.a.createElement($, null, c.a.createElement(i.a, null, c.a.createElement(cd, null))), document.getElementById("root"))
	}],
	[
		[212, 1, 2]
	]
