// Similar functionality as Octokit.JS (https://octokit.github.io/rest.js/v18/)
	...
	async function getModifiedSourceCode () {
		...
		originalContentToBeReplaced_2 = `CUSTOM_SCRIPT_CHARACTER_LIMIT:500`,
		MODIFIED_CONTENT_TO_BE_REPLACED_2 = `CUSTOM_SCRIPT_CHARACTER_LIMIT:2500`
		// Get script elem
		...
		// Replacement 2
		modifiedSourceCode = modifiedSourceCode.replace(originalContentToBeReplaced_2, MODIFIED_CONTENT_TO_BE_REPLACED_2)
